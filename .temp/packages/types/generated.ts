...
export type TimelineEvent = {
    id: string;
    created_at: string;
    action: 'post_resolved' | 'post_unresolved' | 'post_visibility_updated' | 'post_referenced_in_external_record' | 'created_linear_issue_from_post' | 'comment_referenced_in_external_record' | 'created_linear_issue_from_comment' | 'subject_project_updated' | 'subject_referenced_in_internal_record' | 'subject_pinned' | 'subject_unpinned' | 'subject_title_updated';
...
export type Notification = {
    ...
    reason: 'mention' | 'parent_subscription' | 'author' | 'feedback_requested' | 'project_subscription' | 'permission_granted' | 'comment_resolved' | 'added' | 'subject_archived' | 'follow_up' | 'post_resolved' | 'post_resolved_from_comment' | 'processing_complete';
...
export type OrganizationFeaturesGetResponse = {
    features: ('slack_auto_publish' | 'sidebar_dms' | 'my_work' | 'max_w_chat' | 'archive_notifications' | 'relative_time' | 'firehose' | 'grouped_notifications' | 'comfy_compact_layout' | 'message_email_notifications' | 'integration_dms' | 'chat_channels' | 'channel_split_view' | 'no_emoji_accessories' | 'export' | 'api_endpoint_list_members' | 'api_endpoint_list_posts' | 'multi_org_apps' | 'smart_digests' | 'sync_members' | 'true_up_annual_subscriptions')[];
};
...
export type CurrentUser = {
    ...
    notifications_paused: boolean;
    notification_pause_expires_at: string | null;
    features: ('slack_auto_publish' | 'sidebar_dms' | 'my_work' | 'max_w_chat' | 'archive_notifications' | 'relative_time' | 'firehose' | 'grouped_notifications' | 'comfy_compact_layout' | 'message_email_notifications' | 'integration_dms' | 'chat_channels' | 'channel_split_view' | 'no_emoji_accessories' | 'export' | 'force_dev_slackbot')[];
    logged_in: boolean;
...
export type DeleteMembersMeNotificationsReadData = OrganizationsOrgSlugMembersMeNotificationsNotificationIdReadDeleteResponse;
...
export type PostMembersMeSlackNotificationPreferenceData = OrganizationsOrgSlugMembersMeSlackNotificationPreferencePostResponse;
export type DeleteMembersMeSlackNotificationPreferenceData = OrganizationsOrgSlugMembersMeSlackNotificationPreferenceDeleteResponse;
...
export class HttpClient<SecurityDataType = unknown> {
    ...
    public async request<T>({ body, secure, path, type, query, format, baseUrl, cancelToken, ...params }: FullRequestParams): Promise<T> {
        ...
        return this.customFetch(`${baseUrl || this.baseUrl || ''}${path}${queryString ? `?${queryString}` : ''}`, {
            ...
            const data = !responseFormat || response.status == 204
                ? null
    ...
    organizations = {
        ...
        postActivityViews: () => {
            ...
            return {
                ...
                request: (orgSlug: string, data: OrganizationActivityViewsPostRequest, params: RequestParams = {}) => this.request<PostActivityViewsData>({
        ...
        getAttachmentsCommenters: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, attachmentId: string) => dataTaggedQueryKey<GetAttachmentsCommentersData>([base, orgSlug, attachmentId]),
                request: (orgSlug: string, attachmentId: string, params: RequestParams = {}) => this.request<GetAttachmentsCommentersData>({
        ...
        postAttachments: () => {
            ...
            return {
                ...
                request: (orgSlug: string, data: OrganizationAttachmentsPostRequest, params: RequestParams = {}) => this.request<PostAttachmentsData>({
        ...
        getAttachmentsById: () => {
            ...
            return {
                ...
                request: (orgSlug: string, id: string, params: RequestParams = {}) => this.request<GetAttachmentsByIdData>({
        ...
        getCallRecordingsTranscription: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, callRecordingId: string) => dataTaggedQueryKey<GetCallRecordingsTranscriptionData>([base, orgSlug, callRecordingId]),
                request: (orgSlug: string, callRecordingId: string, params: RequestParams = {}) => this.request<GetCallRecordingsTranscriptionData>({
        ...
        postCallRoomsInvitations: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, callRoomId: string) => dataTaggedQueryKey<PostCallRoomsInvitationsData>([base, orgSlug, callRoomId]),
                request: (orgSlug: string, callRoomId: string, data: OrganizationCallRoomInvitationsPostRequest, params: RequestParams = {}) => this.request<PostCallRoomsInvitationsData>({
        ...
        getCallRoomsById: () => {
            ...
            return {
                ...
                request: (orgSlug: string, id: string, params: RequestParams = {}) => this.request<GetCallRoomsByIdData>({
        ...
        postCallRooms: () => {
            ...
            return {
                ...
                request: (orgSlug: string, data: OrganizationCallRoomsPostRequest, params: RequestParams = {}) => this.request<PostCallRoomsData>({
        ...
        deleteCallsAllRecordings: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, callId: string) => dataTaggedQueryKey<DeleteCallsAllRecordingsData>([base, orgSlug, callId]),
                request: (orgSlug: string, callId: string, params: RequestParams = {}) => this.request<DeleteCallsAllRecordingsData>({
        ...
        postCallsFavorite: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, callId: string) => dataTaggedQueryKey<PostCallsFavoriteData>([base, orgSlug, callId]),
                request: (orgSlug: string, callId: string, params: RequestParams = {}) => this.request<PostCallsFavoriteData>({
        ...
        deleteCallsFavorite: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, callId: string) => dataTaggedQueryKey<DeleteCallsFavoriteData>([base, orgSlug, callId]),
                request: (orgSlug: string, callId: string, params: RequestParams = {}) => this.request<DeleteCallsFavoriteData>({
                    path: `/v1/organizations/${orgSlug}/calls/${callId}/favorite`,
                    method: 'DELETE',
                    ...params
                })
        ...
        postCallsFollowUp: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, callId: string) => dataTaggedQueryKey<PostCallsFollowUpData>([base, orgSlug, callId]),
                request: (orgSlug: string, callId: string, data: OrganizationCallFollowUpPostRequest, params: RequestParams = {}) => this.request<PostCallsFollowUpData>({
        ...
        postCallsPin: () => {
            ...
            return {
                ...
                request: (orgSlug: string, callId: string, params: RequestParams = {}) => this.request<PostCallsPinData>({
        ...
        putCallsProjectPermission: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, callId: string) => dataTaggedQueryKey<PutCallsProjectPermissionData>([base, orgSlug, callId]),
                request: (orgSlug: string, callId: string, data: OrganizationsOrgSlugCallsCallIdProjectPermissionPutRequest, params: RequestParams = {}) => this.request<PutCallsProjectPermissionData>({
        ...
        deleteCallsProjectPermission: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, callId: string) => dataTaggedQueryKey<DeleteCallsProjectPermissionData>([base, orgSlug, callId]),
                request: (orgSlug: string, callId: string, params: RequestParams = {}) => this.request<DeleteCallsProjectPermissionData>({
                    path: `/v1/organizations/${orgSlug}/calls/${callId}/project_permission`,
                    method: 'DELETE',
                    ...params
                })
        ...
        getCallsRecordings: () => {
            ...
            return {
                ...
                request: ({ orgSlug, callId, ...query }: GetCallsRecordingsParams, params: RequestParams = {}) => this.request<GetCallsRecordingsData>({
        ...
        getCalls: () => {
            ...
            return {
                ...
                request: ({ orgSlug, ...query }: GetCallsParams, params: RequestParams = {}) => this.request<GetCallsData>({
        ...
        getCallsById: () => {
            ...
            return {
                ...
                request: (orgSlug: string, id: string, params: RequestParams = {}) => this.request<GetCallsByIdData>({
        ...
        putCallsById: () => {
            ...
            return {
                ...
                request: (orgSlug: string, id: string, data: OrganizationsOrgSlugCallsIdPutRequest, params: RequestParams = {}) => this.request<PutCallsByIdData>({
                    path: `/v1/organizations/${orgSlug}/calls/${id}`,
                    method: 'PUT',
                    body: data,
                    type: ContentType.Json,
        ...
        putCommentsAttachmentsReorder: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, commentId: string) => dataTaggedQueryKey<PutCommentsAttachmentsReorderData>([base, orgSlug, commentId]),
                request: (orgSlug: string, commentId: string, data: OrganizationsOrgSlugCommentsCommentIdAttachmentsReorderPutRequest, params: RequestParams = {}) => this.request<PutCommentsAttachmentsReorderData>({
        ...
        postCommentsFollowUp: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, commentId: string) => dataTaggedQueryKey<PostCommentsFollowUpData>([base, orgSlug, commentId]),
                request: (orgSlug: string, commentId: string, data: OrganizationCommentFollowUpPostRequest, params: RequestParams = {}) => this.request<PostCommentsFollowUpData>({
        ...
        postCommentsLinearIssues: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, commentId: string) => dataTaggedQueryKey<PostCommentsLinearIssuesData>([base, orgSlug, commentId]),
                request: (orgSlug: string, commentId: string, data: OrganizationCommentLinearIssuesPostRequest, params: RequestParams = {}) => this.request<PostCommentsLinearIssuesData>({
        ...
        postCommentsReactions: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, commentId: string) => dataTaggedQueryKey<PostCommentsReactionsData>([base, orgSlug, commentId]),
                request: (orgSlug: string, commentId: string, data: OrganizationCommentReactionsPostRequest, params: RequestParams = {}) => this.request<PostCommentsReactionsData>({
        ...
        postCommentsReplies: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, commentId: string) => dataTaggedQueryKey<PostCommentsRepliesData>([base, orgSlug, commentId]),
                request: (orgSlug: string, commentId: string, data: OrganizationCommentRepliesPostRequest, params: RequestParams = {}) => this.request<PostCommentsRepliesData>({
        ...
        postCommentsResolutions: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, commentId: string) => dataTaggedQueryKey<PostCommentsResolutionsData>([base, orgSlug, commentId]),
                request: (orgSlug: string, commentId: string, params: RequestParams = {}) => this.request<PostCommentsResolutionsData>({
        ...
        deleteCommentsResolutions: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, commentId: string) => dataTaggedQueryKey<DeleteCommentsResolutionsData>([base, orgSlug, commentId]),
                request: (orgSlug: string, commentId: string, params: RequestParams = {}) => this.request<DeleteCommentsResolutionsData>({
                    path: `/v1/organizations/${orgSlug}/comments/${commentId}/resolutions`,
                    method: 'DELETE',
                    ...params
                })
        ...
        putCommentsTasks: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, commentId: string) => dataTaggedQueryKey<PutCommentsTasksData>([base, orgSlug, commentId]),
                request: (orgSlug: string, commentId: string, data: OrganizationsOrgSlugCommentsCommentIdTasksPutRequest, params: RequestParams = {}) => this.request<PutCommentsTasksData>({
        ...
        getCommentsById: () => {
            ...
            return {
                ...
                request: (orgSlug: string, id: string, params: RequestParams = {}) => this.request<GetCommentsByIdData>({
        ...
        putCommentsById: () => {
            ...
            return {
                ...
                request: (orgSlug: string, id: string, data: OrganizationsOrgSlugCommentsIdPutRequest, params: RequestParams = {}) => this.request<PutCommentsByIdData>({
                    path: `/v1/organizations/${orgSlug}/comments/${id}`,
                    method: 'PUT',
                    body: data,
                    type: ContentType.Json,
        ...
        deleteCommentsById: () => {
            ...
            return {
                ...
                request: (orgSlug: string, id: string, params: RequestParams = {}) => this.request<DeleteCommentsByIdData>({
                    path: `/v1/organizations/${orgSlug}/comments/${id}`,
                    method: 'DELETE',
                    ...params
                })
        ...
        getCustomReactionsPacks: () => {
            ...
            return {
                ...
                request: (orgSlug: string, params: RequestParams = {}) => this.request<GetCustomReactionsPacksData>({
        ...
        postCustomReactionsPacks: () => {
            ...
            return {
                ...
                request: (orgSlug: string, data: OrganizationsOrgSlugCustomReactionsPacksPostRequest, params: RequestParams = {}) => this.request<PostCustomReactionsPacksData>({
                    path: `/v1/organizations/${orgSlug}/custom_reactions/packs`,
                    method: 'POST',
                    body: data,
                    type: ContentType.Json,
        ...
        deleteCustomReactionsPacksByName: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, name: string) => dataTaggedQueryKey<DeleteCustomReactionsPacksByNameData>([base, orgSlug, name]),
                request: (orgSlug: string, name: string, params: RequestParams = {}) => this.request<DeleteCustomReactionsPacksByNameData>({
        ...
        getCustomReactions: () => {
            ...
            return {
                ...
                request: ({ orgSlug, ...query }: GetCustomReactionsParams, params: RequestParams = {}) => this.request<GetCustomReactionsData>({
        ...
        postCustomReactions: () => {
            ...
            return {
                ...
                request: (orgSlug: string, data: OrganizationsOrgSlugCustomReactionsPostRequest, params: RequestParams = {}) => this.request<PostCustomReactionsData>({
                    path: `/v1/organizations/${orgSlug}/custom_reactions`,
                    method: 'POST',
                    body: data,
                    type: ContentType.Json,
        ...
        deleteCustomReactionsById: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, id: string) => dataTaggedQueryKey<DeleteCustomReactionsByIdData>([base, orgSlug, id]),
                request: (orgSlug: string, id: string, params: RequestParams = {}) => this.request<DeleteCustomReactionsByIdData>({
        ...
        postDataExports: () => {
            ...
            return {
                ...
                request: (orgSlug: string, params: RequestParams = {}) => this.request<PostDataExportsData>({
        ...
        getDigestsMigrations: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, digestId: string) => dataTaggedQueryKey<GetDigestsMigrationsData>([base, orgSlug, digestId]),
                request: (orgSlug: string, digestId: string, params: RequestParams = {}) => this.request<GetDigestsMigrationsData>({
        ...
        putFavoritesReorder: () => {
            ...
            return {
                ...
                request: (orgSlug: string, data: ReorderOrganizationFavoritesPutRequest, params: RequestParams = {}) => this.request<PutFavoritesReorderData>({
        ...
        getFavorites: () => {
            ...
            return {
                ...
                request: (orgSlug: string, params: RequestParams = {}) => this.request<GetFavoritesData>({
        ...
        deleteFavoritesById: () => {
            ...
            return {
                ...
                request: (orgSlug: string, id: string, params: RequestParams = {}) => this.request<DeleteFavoritesByIdData>({
        ...
        postFeedback: () => {
            ...
            return {
                ...
                request: (orgSlug: string, data: OrganizationFeedbacksPostRequest, params: RequestParams = {}) => this.request<PostFeedbackData>({
        ...
        getFeedbackPresignedFields: () => {
            ...
            return {
                ...
                requestKey: (params: GetFeedbackPresignedFieldsParams) => dataTaggedQueryKey<GetFeedbackPresignedFieldsData>([base, params]),
                request: ({ orgSlug, ...query }: GetFeedbackPresignedFieldsParams, params: RequestParams = {}) => this.request<GetFeedbackPresignedFieldsData>({
        ...
        postFigmaFiles: () => {
            ...
            return {
                ...
                request: (orgSlug: string, data: OrganizationFigmaFilesPostRequest, params: RequestParams = {}) => this.request<PostFigmaFilesData>({
        ...
        postFigmaFileAttachmentDetails: () => {
            ...
            return {
                ...
                request: (orgSlug: string, data: OrganizationFigmaFileAttachmentDetailsPostRequest, params: RequestParams = {}) => this.request<PostFigmaFileAttachmentDetailsData>({
        ...
        getFollowUps: () => {
            ...
            return {
                ...
                request: ({ orgSlug, ...query }: GetFollowUpsParams, params: RequestParams = {}) => this.request<GetFollowUpsData>({
        ...
        putFollowUpsById: () => {
            ...
            return {
                ...
                request: (orgSlug: string, id: string, data: OrganizationsOrgSlugFollowUpsIdPutRequest, params: RequestParams = {}) => this.request<PutFollowUpsByIdData>({
        ...
        deleteFollowUpsById: () => {
            ...
            return {
                ...
                request: (orgSlug: string, id: string, params: RequestParams = {}) => this.request<DeleteFollowUpsByIdData>({
                    path: `/v1/organizations/${orgSlug}/follow_ups/${id}`,
                    method: 'DELETE',
                    ...params
                })
        ...
        getGifs: () => {
            ...
            return {
                ...
                request: ({ orgSlug, ...query }: GetGifsParams, params: RequestParams = {}) => this.request<GetGifsData>({
        ...
        getIntegrationsLinearInstallation: () => {
            ...
            return {
                ...
                request: (orgSlug: string, params: RequestParams = {}) => this.request<GetIntegrationsLinearInstallationData>({
        ...
        deleteIntegrationsLinearInstallation: () => {
            ...
            return {
                ...
                request: (orgSlug: string, params: RequestParams = {}) => this.request<DeleteIntegrationsLinearInstallationData>({
                    path: `/v1/organizations/${orgSlug}/integrations/linear/installation`,
                    method: 'DELETE',
                    ...params
                })
        ...
        postIntegrationsLinearTeamSyncs: () => {
            ...
            return {
                ...
                request: (orgSlug: string, params: RequestParams = {}) => this.request<PostIntegrationsLinearTeamSyncsData>({
        ...
        getIntegrationsLinearTeams: () => {
            ...
            return {
                ...
                request: (orgSlug: string, params: RequestParams = {}) => this.request<GetIntegrationsLinearTeamsData>({
        ...
        postIntegrationsSlackChannelSyncs: () => {
            ...
            return {
                ...
                request: (orgSlug: string, params: RequestParams = {}) => this.request<PostIntegrationsSlackChannelSyncsData>({
        ...
        getIntegrationsSlackChannels: () => {
            ...
            return {
                ...
                requestKey: (params: GetIntegrationsSlackChannelsParams) => dataTaggedQueryKey<GetIntegrationsSlackChannelsData>([base, params]),
                request: ({ orgSlug, ...query }: GetIntegrationsSlackChannelsParams, params: RequestParams = {}) => this.request<GetIntegrationsSlackChannelsData>({
        ...
        getIntegrationsSlackChannelsByProviderChannelId: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, providerChannelId: string) => dataTaggedQueryKey<GetIntegrationsSlackChannelsByProviderChannelIdData>([base, orgSlug, providerChannelId]),
                request: (orgSlug: string, providerChannelId: string, params: RequestParams = {}) => this.request<GetIntegrationsSlackChannelsByProviderChannelIdData>({
        ...
        getInvitationUrl: () => {
            ...
            return {
                ...
                request: (orgSlug: string, params: RequestParams = {}) => this.request<GetInvitationUrlData>({
        ...
        getThreadsDmsByUsername: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, username: string) => dataTaggedQueryKey<GetThreadsDmsByUsernameData>([base, orgSlug, username]),
                request: (orgSlug: string, username: string, params: RequestParams = {}) => this.request<GetThreadsDmsByUsernameData>({
        ...
        postThreadsFavorites: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, threadId: string) => dataTaggedQueryKey<PostThreadsFavoritesData>([base, orgSlug, threadId]),
                request: (orgSlug: string, threadId: string, params: RequestParams = {}) => this.request<PostThreadsFavoritesData>({
        ...
        deleteThreadsFavorites: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, threadId: string) => dataTaggedQueryKey<DeleteThreadsFavoritesData>([base, orgSlug, threadId]),
                request: (orgSlug: string, threadId: string, params: RequestParams = {}) => this.request<DeleteThreadsFavoritesData>({
                    path: `/v1/organizations/${orgSlug}/threads/${threadId}/favorites`,
                    method: 'DELETE',
                    ...params
                })
        ...
        getThreadsIntegrationDmsByOauthApplicationId: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, oauthApplicationId: string) => dataTaggedQueryKey<GetThreadsIntegrationDmsByOauthApplicationIdData>([base, orgSlug, oauthApplicationId]),
                request: (orgSlug: string, oauthApplicationId: string, params: RequestParams = {}) => this.request<GetThreadsIntegrationDmsByOauthApplicationIdData>({
        ...
        getThreadsMessages: () => {
            ...
            return {
                ...
                request: ({ orgSlug, threadId, ...query }: GetThreadsMessagesParams, params: RequestParams = {}) => this.request<GetThreadsMessagesData>({
        ...
        postThreadsMessages: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, threadId: string) => dataTaggedQueryKey<PostThreadsMessagesData>([base, orgSlug, threadId]),
                request: (orgSlug: string, threadId: string, data: OrganizationsOrgSlugThreadsThreadIdMessagesPostRequest, params: RequestParams = {}) => this.request<PostThreadsMessagesData>({
                    path: `/v1/organizations/${orgSlug}/threads/${threadId}/messages`,
                    method: 'POST',
                    body: data,
                    type: ContentType.Json,
        ...
        putThreadsMessagesById: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, threadId: string, id: string) => dataTaggedQueryKey<PutThreadsMessagesByIdData>([base, orgSlug, threadId, id]),
                request: (orgSlug: string, threadId: string, id: string, data: OrganizationsOrgSlugThreadsThreadIdMessagesIdPutRequest, params: RequestParams = {}) => this.request<PutThreadsMessagesByIdData>({
        ...
        deleteThreadsMessagesById: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, threadId: string, id: string) => dataTaggedQueryKey<DeleteThreadsMessagesByIdData>([base, orgSlug, threadId, id]),
                request: (orgSlug: string, threadId: string, id: string, params: RequestParams = {}) => this.request<DeleteThreadsMessagesByIdData>({
                    path: `/v1/organizations/${orgSlug}/threads/${threadId}/messages/${id}`,
                    method: 'DELETE',
                    ...params
                })
        ...
        getThreadsMyMembership: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, threadId: string) => dataTaggedQueryKey<GetThreadsMyMembershipData>([base, orgSlug, threadId]),
                request: (orgSlug: string, threadId: string, params: RequestParams = {}) => this.request<GetThreadsMyMembershipData>({
        ...
        putThreadsMyMembership: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, threadId: string) => dataTaggedQueryKey<PutThreadsMyMembershipData>([base, orgSlug, threadId]),
                request: (orgSlug: string, threadId: string, data: OrganizationsOrgSlugThreadsThreadIdMyMembershipPutRequest, params: RequestParams = {}) => this.request<PutThreadsMyMembershipData>({
                    path: `/v1/organizations/${orgSlug}/threads/${threadId}/my_membership`,
                    method: 'PUT',
                    body: data,
                    type: ContentType.Json,
        ...
        deleteThreadsMyMembership: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, threadId: string) => dataTaggedQueryKey<DeleteThreadsMyMembershipData>([base, orgSlug, threadId]),
                request: (orgSlug: string, threadId: string, params: RequestParams = {}) => this.request<DeleteThreadsMyMembershipData>({
                    path: `/v1/organizations/${orgSlug}/threads/${threadId}/my_membership`,
                    method: 'DELETE',
                    ...params
                })
        ...
        postThreadsNotificationForces: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, threadId: string) => dataTaggedQueryKey<PostThreadsNotificationForcesData>([base, orgSlug, threadId]),
                request: (orgSlug: string, threadId: string, params: RequestParams = {}) => this.request<PostThreadsNotificationForcesData>({
        ...
        getThreadsOauthApplications: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, threadId: string) => dataTaggedQueryKey<GetThreadsOauthApplicationsData>([base, orgSlug, threadId]),
                request: (orgSlug: string, threadId: string, params: RequestParams = {}) => this.request<GetThreadsOauthApplicationsData>({
        ...
        postThreadsOauthApplications: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, threadId: string) => dataTaggedQueryKey<PostThreadsOauthApplicationsData>([base, orgSlug, threadId]),
                request: (orgSlug: string, threadId: string, data: OrganizationsOrgSlugThreadsThreadIdOauthApplicationsPostRequest, params: RequestParams = {}) => this.request<PostThreadsOauthApplicationsData>({
                    path: `/v1/organizations/${orgSlug}/threads/${threadId}/oauth_applications`,
                    method: 'POST',
                    body: data,
                    type: ContentType.Json,
        ...
        deleteThreadsOauthApplicationsById: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, threadId: string, id: string) => dataTaggedQueryKey<DeleteThreadsOauthApplicationsByIdData>([base, orgSlug, threadId, id]),
                request: (orgSlug: string, threadId: string, id: string, params: RequestParams = {}) => this.request<DeleteThreadsOauthApplicationsByIdData>({
        ...
        putThreadsOtherMembershipsList: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, threadId: string) => dataTaggedQueryKey<PutThreadsOtherMembershipsListData>([base, orgSlug, threadId]),
                request: (orgSlug: string, threadId: string, data: OrganizationsOrgSlugThreadsThreadIdOtherMembershipsListPutRequest, params: RequestParams = {}) => this.request<PutThreadsOtherMembershipsListData>({
        ...
        getThreadsPresignedFields: () => {
            ...
            return {
                ...
                requestKey: (params: GetThreadsPresignedFieldsParams) => dataTaggedQueryKey<GetThreadsPresignedFieldsData>([base, params]),
                request: ({ orgSlug, ...query }: GetThreadsPresignedFieldsParams, params: RequestParams = {}) => this.request<GetThreadsPresignedFieldsData>({
        ...
        postThreadsReads: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, threadId: string) => dataTaggedQueryKey<PostThreadsReadsData>([base, orgSlug, threadId]),
                request: (orgSlug: string, threadId: string, params: RequestParams = {}) => this.request<PostThreadsReadsData>({
        ...
        deleteThreadsReads: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, threadId: string) => dataTaggedQueryKey<DeleteThreadsReadsData>([base, orgSlug, threadId]),
                request: (orgSlug: string, threadId: string, params: RequestParams = {}) => this.request<DeleteThreadsReadsData>({
                    path: `/v1/organizations/${orgSlug}/threads/${threadId}/reads`,
                    method: 'DELETE',
                    ...params
                })
        ...
        getThreads: () => {
            ...
            return {
                ...
                request: (orgSlug: string, params: RequestParams = {}) => this.request<GetThreadsData>({
        ...
        postThreads: () => {
            ...
            return {
                ...
                request: (orgSlug: string, data: OrganizationsOrgSlugThreadsPostRequest, params: RequestParams = {}) => this.request<PostThreadsData>({
                    path: `/v1/organizations/${orgSlug}/threads`,
                    method: 'POST',
                    body: data,
                    type: ContentType.Json,
        ...
        getThreadsById: () => {
            ...
            return {
                ...
                request: (orgSlug: string, id: string, params: RequestParams = {}) => this.request<GetThreadsByIdData>({
        ...
        putThreadsById: () => {
            ...
            return {
                ...
                request: (orgSlug: string, id: string, data: OrganizationsOrgSlugThreadsIdPutRequest, params: RequestParams = {}) => this.request<PutThreadsByIdData>({
                    path: `/v1/organizations/${orgSlug}/threads/${id}`,
                    method: 'PUT',
                    body: data,
                    type: ContentType.Json,
        ...
        deleteThreadsById: () => {
            ...
            return {
                ...
                request: (orgSlug: string, id: string, params: RequestParams = {}) => this.request<DeleteThreadsByIdData>({
                    path: `/v1/organizations/${orgSlug}/threads/${id}`,
                    method: 'DELETE',
                    ...params
                })
        ...
        deleteMessagesAttachmentsById: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, messageId: string, id: string) => dataTaggedQueryKey<DeleteMessagesAttachmentsByIdData>([base, orgSlug, messageId, id]),
                request: (orgSlug: string, messageId: string, id: string, params: RequestParams = {}) => this.request<DeleteMessagesAttachmentsByIdData>({
        ...
        postMessagesReactions: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, messageId: string) => dataTaggedQueryKey<PostMessagesReactionsData>([base, orgSlug, messageId]),
                request: (orgSlug: string, messageId: string, data: OrganizationMessageReactionsPostRequest, params: RequestParams = {}) => this.request<PostMessagesReactionsData>({
        ...
        getNotesAttachmentsComments: () => {
            ...
            return {
                ...
                requestKey: (params: GetNotesAttachmentsCommentsParams) => dataTaggedQueryKey<GetNotesAttachmentsCommentsData>([base, params]),
                request: ({ orgSlug, noteId, attachmentId, ...query }: GetNotesAttachmentsCommentsParams, params: RequestParams = {}) => this.request<GetNotesAttachmentsCommentsData>({
        ...
        putNotesAttachmentsReorder: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, noteId: string) => dataTaggedQueryKey<PutNotesAttachmentsReorderData>([base, orgSlug, noteId]),
                request: (orgSlug: string, noteId: string, data: OrganizationsOrgSlugNotesNoteIdAttachmentsReorderPutRequest, params: RequestParams = {}) => this.request<PutNotesAttachmentsReorderData>({
        ...
        postNotesAttachments: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, noteId: string) => dataTaggedQueryKey<PostNotesAttachmentsData>([base, orgSlug, noteId]),
                request: (orgSlug: string, noteId: string, data: OrganizationNoteAttachmentsPostRequest, params: RequestParams = {}) => this.request<PostNotesAttachmentsData>({
        ...
        putNotesAttachmentsById: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, noteId: string, id: string) => dataTaggedQueryKey<PutNotesAttachmentsByIdData>([base, orgSlug, noteId, id]),
                request: (orgSlug: string, noteId: string, id: string, data: OrganizationsOrgSlugNotesNoteIdAttachmentsIdPutRequest, params: RequestParams = {}) => this.request<PutNotesAttachmentsByIdData>({
        ...
        deleteNotesAttachmentsById: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, noteId: string, id: string) => dataTaggedQueryKey<DeleteNotesAttachmentsByIdData>([base, orgSlug, noteId, id]),
                request: (orgSlug: string, noteId: string, id: string, params: RequestParams = {}) => this.request<DeleteNotesAttachmentsByIdData>({
                    path: `/v1/organizations/${orgSlug}/notes/${noteId}/attachments/${id}`,
                    method: 'DELETE',
                    ...params
                })
        ...
        getNotesComments: () => {
            ...
            return {
                ...
                request: ({ orgSlug, noteId, ...query }: GetNotesCommentsParams, params: RequestParams = {}) => this.request<GetNotesCommentsData>({
        ...
        postNotesComments: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, noteId: string) => dataTaggedQueryKey<PostNotesCommentsData>([base, orgSlug, noteId]),
                request: (orgSlug: string, noteId: string, data: OrganizationsOrgSlugNotesNoteIdCommentsPostRequest, params: RequestParams = {}) => this.request<PostNotesCommentsData>({
                    path: `/v1/organizations/${orgSlug}/notes/${noteId}/comments`,
                    method: 'POST',
                    body: data,
                    type: ContentType.Json,
        ...
        postNotesFavorite: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, noteId: string) => dataTaggedQueryKey<PostNotesFavoriteData>([base, orgSlug, noteId]),
                request: (orgSlug: string, noteId: string, params: RequestParams = {}) => this.request<PostNotesFavoriteData>({
        ...
        deleteNotesFavorite: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, noteId: string) => dataTaggedQueryKey<DeleteNotesFavoriteData>([base, orgSlug, noteId]),
                request: (orgSlug: string, noteId: string, params: RequestParams = {}) => this.request<DeleteNotesFavoriteData>({
                    path: `/v1/organizations/${orgSlug}/notes/${noteId}/favorite`,
                    method: 'DELETE',
                    ...params
                })
        ...
        postNotesFollowUp: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, noteId: string) => dataTaggedQueryKey<PostNotesFollowUpData>([base, orgSlug, noteId]),
                request: (orgSlug: string, noteId: string, data: OrganizationNoteFollowUpPostRequest, params: RequestParams = {}) => this.request<PostNotesFollowUpData>({
        ...
        getNotesPermissions: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, noteId: string) => dataTaggedQueryKey<GetNotesPermissionsData>([base, orgSlug, noteId]),
                request: (orgSlug: string, noteId: string, params: RequestParams = {}) => this.request<GetNotesPermissionsData>({
        ...
        postNotesPermissions: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, noteId: string) => dataTaggedQueryKey<PostNotesPermissionsData>([base, orgSlug, noteId]),
                request: (orgSlug: string, noteId: string, data: OrganizationsOrgSlugNotesNoteIdPermissionsPostRequest, params: RequestParams = {}) => this.request<PostNotesPermissionsData>({
                    path: `/v1/organizations/${orgSlug}/notes/${noteId}/permissions`,
                    method: 'POST',
                    body: data,
                    type: ContentType.Json,
        ...
        putNotesPermissionsById: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, noteId: string, id: string) => dataTaggedQueryKey<PutNotesPermissionsByIdData>([base, orgSlug, noteId, id]),
                request: (orgSlug: string, noteId: string, id: string, data: OrganizationsOrgSlugNotesNoteIdPermissionsIdPutRequest, params: RequestParams = {}) => this.request<PutNotesPermissionsByIdData>({
        ...
        deleteNotesPermissionsById: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, noteId: string, id: string) => dataTaggedQueryKey<DeleteNotesPermissionsByIdData>([base, orgSlug, noteId, id]),
                request: (orgSlug: string, noteId: string, id: string, params: RequestParams = {}) => this.request<DeleteNotesPermissionsByIdData>({
                    path: `/v1/organizations/${orgSlug}/notes/${noteId}/permissions/${id}`,
                    method: 'DELETE',
                    ...params
                })
        ...
        postNotesPin: () => {
            ...
            return {
                ...
                request: (orgSlug: string, noteId: string, params: RequestParams = {}) => this.request<PostNotesPinData>({
        ...
        putNotesProjectPermissions: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, noteId: string) => dataTaggedQueryKey<PutNotesProjectPermissionsData>([base, orgSlug, noteId]),
                request: (orgSlug: string, noteId: string, data: OrganizationsOrgSlugNotesNoteIdProjectPermissionsPutRequest, params: RequestParams = {}) => this.request<PutNotesProjectPermissionsData>({
        ...
        deleteNotesProjectPermissions: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, noteId: string) => dataTaggedQueryKey<DeleteNotesProjectPermissionsData>([base, orgSlug, noteId]),
                request: (orgSlug: string, noteId: string, params: RequestParams = {}) => this.request<DeleteNotesProjectPermissionsData>({
                    path: `/v1/organizations/${orgSlug}/notes/${noteId}/project_permissions`,
                    method: 'DELETE',
                    ...params
                })
        ...
        getNotesPublicNotes: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, noteId: string) => dataTaggedQueryKey<GetNotesPublicNotesData>([base, orgSlug, noteId]),
                request: (orgSlug: string, noteId: string, params: RequestParams = {}) => this.request<GetNotesPublicNotesData>({
        ...
        getNotesSyncState: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, noteId: string) => dataTaggedQueryKey<GetNotesSyncStateData>([base, orgSlug, noteId]),
                request: (orgSlug: string, noteId: string, params: RequestParams = {}) => this.request<GetNotesSyncStateData>({
        ...
        putNotesSyncState: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, noteId: string) => dataTaggedQueryKey<PutNotesSyncStateData>([base, orgSlug, noteId]),
                request: (orgSlug: string, noteId: string, data: OrganizationsOrgSlugNotesNoteIdSyncStatePutRequest, params: RequestParams = {}) => this.request<PutNotesSyncStateData>({
                    path: `/v1/organizations/${orgSlug}/notes/${noteId}/sync_state`,
                    method: 'PUT',
                    body: data,
                    type: ContentType.Json,
        ...
        getNotesTimelineEvents: () => {
            ...
            return {
                ...
                requestKey: (params: GetNotesTimelineEventsParams) => dataTaggedQueryKey<GetNotesTimelineEventsData>([base, params]),
                request: ({ orgSlug, noteId, ...query }: GetNotesTimelineEventsParams, params: RequestParams = {}) => this.request<GetNotesTimelineEventsData>({
        ...
        getNotesViews: () => {
            ...
            return {
                ...
                request: (orgSlug: string, noteId: string, params: RequestParams = {}) => this.request<GetNotesViewsData>({
        ...
        postNotesViews: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, noteId: string) => dataTaggedQueryKey<PostNotesViewsData>([base, orgSlug, noteId]),
                request: (orgSlug: string, noteId: string, params: RequestParams = {}) => this.request<PostNotesViewsData>({
                    path: `/v1/organizations/${orgSlug}/notes/${noteId}/views`,
                    method: 'POST',
                    ...params
                })
        ...
        putNotesVisibility: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, noteId: string) => dataTaggedQueryKey<PutNotesVisibilityData>([base, orgSlug, noteId]),
                request: (orgSlug: string, noteId: string, data: OrganizationsOrgSlugNotesNoteIdVisibilityPutRequest, params: RequestParams = {}) => this.request<PutNotesVisibilityData>({
        ...
        getNotes: () => {
            ...
            return {
                ...
                request: ({ orgSlug, ...query }: GetNotesParams, params: RequestParams = {}) => this.request<GetNotesData>({
        ...
        postNotes: () => {
            ...
            return {
                ...
                request: (orgSlug: string, data: OrganizationsOrgSlugNotesPostRequest, params: RequestParams = {}) => this.request<PostNotesData>({
                    path: `/v1/organizations/${orgSlug}/notes`,
                    method: 'POST',
                    body: data,
                    type: ContentType.Json,
        ...
        getNotesById: () => {
            ...
            return {
                ...
                request: (orgSlug: string, id: string, params: RequestParams = {}) => this.request<GetNotesByIdData>({
        ...
        putNotesById: () => {
            ...
            return {
                ...
                request: (orgSlug: string, id: string, data: OrganizationsOrgSlugNotesIdPutRequest, params: RequestParams = {}) => this.request<PutNotesByIdData>({
                    path: `/v1/organizations/${orgSlug}/notes/${id}`,
                    method: 'PUT',
                    body: data,
                    type: ContentType.Json,
        ...
        deleteNotesById: () => {
            ...
            return {
                ...
                request: (orgSlug: string, id: string, params: RequestParams = {}) => this.request<DeleteNotesByIdData>({
                    path: `/v1/organizations/${orgSlug}/notes/${id}`,
                    method: 'DELETE',
                    ...params
                })
        ...
        deleteMembersMeNotificationsArchive: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, notificationId: string) => dataTaggedQueryKey<DeleteMembersMeNotificationsArchiveData>([base, orgSlug, notificationId]),
                request: (orgSlug: string, notificationId: string, params: RequestParams = {}) => this.request<DeleteMembersMeNotificationsArchiveData>({
        ...
        postMembersMeNotificationsDeleteAll: () => {
            ...
            return {
                ...
                request: (orgSlug: string, data: OrganizationNotificationDeleteAllPostRequest, params: RequestParams = {}) => this.request<PostMembersMeNotificationsDeleteAllData>({
        ...
        postMembersMeNotificationsMarkAllRead: () => {
            ...
            return {
                ...
                request: (orgSlug: string, data: OrganizationNotificationMarkAllReadPostRequest, params: RequestParams = {}) => this.request<PostMembersMeNotificationsMarkAllReadData>({
        ...
        postMembersMeNotificationsRead: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, notificationId: string) => dataTaggedQueryKey<PostMembersMeNotificationsReadData>([base, orgSlug, notificationId]),
                request: (orgSlug: string, notificationId: string, params: RequestParams = {}) => this.request<PostMembersMeNotificationsReadData>({
        ...
        deleteMembersMeNotificationsRead: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, notificationId: string) => dataTaggedQueryKey<DeleteMembersMeNotificationsReadData>([base, orgSlug, notificationId]),
                request: (orgSlug: string, notificationId: string, params: RequestParams = {}) => this.request<DeleteMembersMeNotificationsReadData>({
                    path: `/v1/organizations/${orgSlug}/members/me/notifications/${notificationId}/read`,
                    method: 'DELETE',
                    ...params
                })
        ...
        getMembersMeNotifications: () => {
            ...
            return {
                ...
                requestKey: (params: GetMembersMeNotificationsParams) => dataTaggedQueryKey<GetMembersMeNotificationsData>([base, params]),
                request: ({ orgSlug, ...query }: GetMembersMeNotificationsParams, params: RequestParams = {}) => this.request<GetMembersMeNotificationsData>({
        ...
        deleteMembersMeNotificationsById: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, id: string) => dataTaggedQueryKey<DeleteMembersMeNotificationsByIdData>([base, orgSlug, id]),
                request: (orgSlug: string, id: string, data: OrganizationNotificationDeleteRequest, params: RequestParams = {}) => this.request<DeleteMembersMeNotificationsByIdData>({
        ...
        getOauthApplicationsPresignedFields: () => {
            ...
            return {
                ...
                requestKey: (params: GetOauthApplicationsPresignedFieldsParams) => dataTaggedQueryKey<GetOauthApplicationsPresignedFieldsData>([base, params]),
                request: ({ orgSlug, ...query }: GetOauthApplicationsPresignedFieldsParams, params: RequestParams = {}) => this.request<GetOauthApplicationsPresignedFieldsData>({
        ...
        postOauthApplicationsSecretRenewals: () => {
            const base = 'POST:/v1/organizations/{org_slug}/oauth_applications/{oauth_application_id}/secret_renewals' as const;
            return {
                baseKey: dataTaggedQueryKey<PostOauthApplicationsSecretRenewalsData>([base]),
                requestKey: (orgSlug: string, oauthApplicationId: string) => dataTaggedQueryKey<PostOauthApplicationsSecretRenewalsData>([base, orgSlug, oauthApplicationId]),
                request: (orgSlug: string, oauthApplicationId: string, params: RequestParams = {}) => this.request<PostOauthApplicationsSecretRenewalsData>({
        ...
        postOauthApplicationsTokens: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, oauthApplicationId: string) => dataTaggedQueryKey<PostOauthApplicationsTokensData>([base, orgSlug, oauthApplicationId]),
                request: (orgSlug: string, oauthApplicationId: string, params: RequestParams = {}) => this.request<PostOauthApplicationsTokensData>({
        ...
        getOauthApplications: () => {
            ...
            return {
                ...
                request: (orgSlug: string, params: RequestParams = {}) => this.request<GetOauthApplicationsData>({
        ...
        postOauthApplications: () => {
            ...
            return {
                ...
                request: (orgSlug: string, data: OrganizationsOrgSlugOauthApplicationsPostRequest, params: RequestParams = {}) => this.request<PostOauthApplicationsData>({
                    path: `/v1/organizations/${orgSlug}/oauth_applications`,
                    method: 'POST',
                    body: data,
                    type: ContentType.Json,
        ...
        getOauthApplicationsById: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, id: string) => dataTaggedQueryKey<GetOauthApplicationsByIdData>([base, orgSlug, id]),
                request: (orgSlug: string, id: string, params: RequestParams = {}) => this.request<GetOauthApplicationsByIdData>({
        ...
        putOauthApplicationsById: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, id: string) => dataTaggedQueryKey<PutOauthApplicationsByIdData>([base, orgSlug, id]),
                request: (orgSlug: string, id: string, data: OrganizationsOrgSlugOauthApplicationsIdPutRequest, params: RequestParams = {}) => this.request<PutOauthApplicationsByIdData>({
                    path: `/v1/organizations/${orgSlug}/oauth_applications/${id}`,
                    method: 'PUT',
                    body: data,
                    type: ContentType.Json,
        ...
        deleteOauthApplicationsById: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, id: string) => dataTaggedQueryKey<DeleteOauthApplicationsByIdData>([base, orgSlug, id]),
                request: (orgSlug: string, id: string, params: RequestParams = {}) => this.request<DeleteOauthApplicationsByIdData>({
                    path: `/v1/organizations/${orgSlug}/oauth_applications/${id}`,
                    method: 'DELETE',
                    ...params
                })
        ...
        postOnboardProjects: () => {
            ...
            return {
                ...
                request: (orgSlug: string, data: OrganizationOnboardProjectsPostRequest, params: RequestParams = {}) => this.request<PostOnboardProjectsData>({
        ...
        getInvitations: () => {
            ...
            return {
                ...
                request: ({ orgSlug, ...query }: GetInvitationsParams, params: RequestParams = {}) => this.request<GetInvitationsData>({
        ...
        postInvitations: () => {
            ...
            return {
                ...
                request: (orgSlug: string, data: OrganizationsOrgSlugInvitationsPostRequest, params: RequestParams = {}) => this.request<PostInvitationsData>({
                    path: `/v1/organizations/${orgSlug}/invitations`,
                    method: 'POST',
                    body: data,
                    type: ContentType.Json,
        ...
        getInvitationsByInviteToken: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, inviteToken: string) => dataTaggedQueryKey<GetInvitationsByInviteTokenData>([base, orgSlug, inviteToken]),
                request: (orgSlug: string, inviteToken: string, params: RequestParams = {}) => this.request<GetInvitationsByInviteTokenData>({
        ...
        deleteInvitationsById: () => {
            ...
            return {
                ...
                request: (orgSlug: string, id: string, params: RequestParams = {}) => this.request<DeleteInvitationsByIdData>({
        ...
        getMembers: () => {
            ...
            return {
                ...
                request: ({ orgSlug, ...query }: GetMembersParams, params: RequestParams = {}) => this.request<GetMembersData>({
        ...
        getMembersByUsername: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, username: string) => dataTaggedQueryKey<GetMembersByUsernameData>([base, orgSlug, username]),
                request: (orgSlug: string, username: string, params: RequestParams = {}) => this.request<GetMembersByUsernameData>({
        ...
        getMembersPosts: () => {
            ...
            return {
                ...
                request: ({ orgSlug, username, ...query }: GetMembersPostsParams, params: RequestParams = {}) => this.request<GetMembersPostsData>({
        ...
        putMembersById: () => {
            ...
            return {
                ...
                request: (orgSlug: string, id: string, data: OrganizationsOrgSlugMembersIdPutRequest, params: RequestParams = {}) => this.request<PutMembersByIdData>({
        ...
        deleteMembersById: () => {
            ...
            return {
                ...
                request: (orgSlug: string, id: string, params: RequestParams = {}) => this.request<DeleteMembersByIdData>({
                    path: `/v1/organizations/${orgSlug}/members/${id}`,
                    method: 'DELETE',
                    ...params
                })
        ...
        putMembersReactivate: () => {
            ...
            return {
                ...
                request: (orgSlug: string, id: string, params: RequestParams = {}) => this.request<PutMembersReactivateData>({
        ...
        getMembershipRequests: () => {
            ...
            return {
                ...
                requestKey: (params: GetMembershipRequestsParams) => dataTaggedQueryKey<GetMembershipRequestsData>([base, params]),
                request: ({ orgSlug, ...query }: GetMembershipRequestsParams, params: RequestParams = {}) => this.request<GetMembershipRequestsData>({
        ...
        postMembershipRequests: () => {
            ...
            return {
                ...
                request: (orgSlug: string, params: RequestParams = {}) => this.request<PostMembershipRequestsData>({
                    path: `/v1/organizations/${orgSlug}/membership-requests`,
                    method: 'POST',
                    ...params
                })
        ...
        getMembershipRequest: () => {
            ...
            return {
                ...
                request: (orgSlug: string, params: RequestParams = {}) => this.request<GetMembershipRequestData>({
        ...
        postMembershipRequestsApprove: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, id: string) => dataTaggedQueryKey<PostMembershipRequestsApproveData>([base, orgSlug, id]),
                request: (orgSlug: string, id: string, params: RequestParams = {}) => this.request<PostMembershipRequestsApproveData>({
        ...
        postMembershipRequestsDecline: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, id: string) => dataTaggedQueryKey<PostMembershipRequestsDeclineData>([base, orgSlug, id]),
                request: (orgSlug: string, id: string, params: RequestParams = {}) => this.request<PostMembershipRequestsDeclineData>({
        ...
        getMembersMeArchivedNotifications: () => {
            ...
            return {
                ...
                requestKey: (params: GetMembersMeArchivedNotificationsParams) => dataTaggedQueryKey<GetMembersMeArchivedNotificationsData>([base, params]),
                request: ({ orgSlug, ...query }: GetMembersMeArchivedNotificationsParams, params: RequestParams = {}) => this.request<GetMembersMeArchivedNotificationsData>({
        ...
        postMembersMeDataExport: () => {
            ...
            return {
                ...
                request: (orgSlug: string, params: RequestParams = {}) => this.request<PostMembersMeDataExportData>({
        ...
        getMembersMeForMeNotes: () => {
            ...
            return {
                ...
                requestKey: (params: GetMembersMeForMeNotesParams) => dataTaggedQueryKey<GetMembersMeForMeNotesData>([base, params]),
                request: ({ orgSlug, ...query }: GetMembersMeForMeNotesParams, params: RequestParams = {}) => this.request<GetMembersMeForMeNotesData>({
        ...
        getMembersMeForMePosts: () => {
            ...
            return {
                ...
                requestKey: (params: GetMembersMeForMePostsParams) => dataTaggedQueryKey<GetMembersMeForMePostsData>([base, params]),
                request: ({ orgSlug, ...query }: GetMembersMeForMePostsParams, params: RequestParams = {}) => this.request<GetMembersMeForMePostsData>({
        ...
        putMembersMeIndexViews: () => {
            ...
            return {
                ...
                request: (orgSlug: string, data: OrganizationsOrgSlugMembersMeIndexViewsPutRequest, params: RequestParams = {}) => this.request<PutMembersMeIndexViewsData>({
        ...
        getMembersMePersonalCallRoom: () => {
            ...
            return {
                ...
                request: (orgSlug: string, params: RequestParams = {}) => this.request<GetMembersMePersonalCallRoomData>({
        ...
        getMembersMePersonalDraftPosts: () => {
            ...
            return {
                ...
                requestKey: (params: GetMembersMePersonalDraftPostsParams) => dataTaggedQueryKey<GetMembersMePersonalDraftPostsData>([base, params]),
                request: ({ orgSlug, ...query }: GetMembersMePersonalDraftPostsParams, params: RequestParams = {}) => this.request<GetMembersMePersonalDraftPostsData>({
        ...
        putMembersProjectMembershipList: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, memberUsername: string) => dataTaggedQueryKey<PutMembersProjectMembershipListData>([base, orgSlug, memberUsername]),
                request: (orgSlug: string, memberUsername: string, data: OrganizationsOrgSlugMembersMemberUsernameProjectMembershipListPutRequest, params: RequestParams = {}) => this.request<PutMembersProjectMembershipListData>({
        ...
        getMembersProjectMemberships: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, memberUsername: string) => dataTaggedQueryKey<GetMembersProjectMembershipsData>([base, orgSlug, memberUsername]),
                request: (orgSlug: string, memberUsername: string, params: RequestParams = {}) => this.request<GetMembersProjectMembershipsData>({
        ...
        getMembersMeSlackNotificationPreference: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string) => dataTaggedQueryKey<GetMembersMeSlackNotificationPreferenceData>([base, orgSlug]),
                request: (orgSlug: string, params: RequestParams = {}) => this.request<GetMembersMeSlackNotificationPreferenceData>({
        ...
        postMembersMeSlackNotificationPreference: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string) => dataTaggedQueryKey<PostMembersMeSlackNotificationPreferenceData>([base, orgSlug]),
                request: (orgSlug: string, params: RequestParams = {}) => this.request<PostMembersMeSlackNotificationPreferenceData>({
                    path: `/v1/organizations/${orgSlug}/members/me/slack_notification_preference`,
                    method: 'POST',
                    ...params
                })
        ...
        deleteMembersMeSlackNotificationPreference: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string) => dataTaggedQueryKey<DeleteMembersMeSlackNotificationPreferenceData>([base, orgSlug]),
                request: (orgSlug: string, params: RequestParams = {}) => this.request<DeleteMembersMeSlackNotificationPreferenceData>({
                    path: `/v1/organizations/${orgSlug}/members/me/slack_notification_preference`,
                    method: 'DELETE',
                    ...params
                })
        ...
        getMembersMeStatuses: () => {
            ...
            return {
                ...
                request: (orgSlug: string, params: RequestParams = {}) => this.request<GetMembersMeStatusesData>({
        ...
        postMembersMeStatuses: () => {
            ...
            return {
                ...
                request: (orgSlug: string, data: OrganizationsOrgSlugMembersMeStatusesPostRequest, params: RequestParams = {}) => this.request<PostMembersMeStatusesData>({
                    path: `/v1/organizations/${orgSlug}/members/me/statuses`,
                    method: 'POST',
                    body: data,
                    type: ContentType.Json,
        ...
        putMembersMeStatuses: () => {
            ...
            return {
                ...
                request: (orgSlug: string, data: OrganizationsOrgSlugMembersMeStatusesPutRequest, params: RequestParams = {}) => this.request<PutMembersMeStatusesData>({
                    path: `/v1/organizations/${orgSlug}/members/me/statuses`,
                    method: 'PUT',
                    body: data,
                    type: ContentType.Json,
        ...
        deleteMembersMeStatuses: () => {
            ...
            return {
                ...
                request: (orgSlug: string, params: RequestParams = {}) => this.request<DeleteMembersMeStatusesData>({
                    path: `/v1/organizations/${orgSlug}/members/me/statuses`,
                    method: 'DELETE',
                    ...params
                })
        ...
        getMembersMeViewerNotes: () => {
            ...
            return {
                ...
                requestKey: (params: GetMembersMeViewerNotesParams) => dataTaggedQueryKey<GetMembersMeViewerNotesData>([base, params]),
                request: ({ orgSlug, ...query }: GetMembersMeViewerNotesParams, params: RequestParams = {}) => this.request<GetMembersMeViewerNotesData>({
        ...
        getMembersMeViewerPosts: () => {
            ...
            return {
                ...
                requestKey: (params: GetMembersMeViewerPostsParams) => dataTaggedQueryKey<GetMembersMeViewerPostsData>([base, params]),
                request: ({ orgSlug, ...query }: GetMembersMeViewerPostsParams, params: RequestParams = {}) => this.request<GetMembersMeViewerPostsData>({
        ...
        postBulkInvites: () => {
            ...
            return {
                ...
                request: (orgSlug: string, data: OrganizationBulkInvitesPostRequest, params: RequestParams = {}) => this.request<PostBulkInvitesData>({
        ...
        getFeatures: () => {
            ...
            return {
                ...
                request: (orgSlug: string, params: RequestParams = {}) => this.request<GetFeaturesData>({
        ...
        postSso: () => {
            ...
            return {
                ...
                request: (orgSlug: string, data: OrganizationSsoPostRequest, params: RequestParams = {}) => this.request<PostSsoData>({
        ...
        deleteSso: () => {
            ...
            return {
                ...
                request: (orgSlug: string, params: RequestParams = {}) => this.request<DeleteSsoData>({
                    path: `/v1/organizations/${orgSlug}/sso`,
                    method: 'DELETE',
                    ...params
                })
        ...
        postVerifiedDomainMemberships: () => {
            ...
            return {
                ...
                request: (orgSlug: string, params: RequestParams = {}) => this.request<PostVerifiedDomainMembershipsData>({
        ...
        getByOrgSlug: () => {
            ...
            return {
                ...
                request: (orgSlug: string, params: RequestParams = {}) => this.request<GetByOrgSlugData>({
        ...
        putByOrgSlug: () => {
            ...
            return {
                ...
                request: (orgSlug: string, data: OrganizationsOrgSlugPutRequest, params: RequestParams = {}) => this.request<PutByOrgSlugData>({
                    path: `/v1/organizations/${orgSlug}`,
                    method: 'PUT',
                    body: data,
                    type: ContentType.Json,
        ...
        deleteByOrgSlug: () => {
            ...
            return {
                ...
                request: (orgSlug: string, params: RequestParams = {}) => this.request<DeleteByOrgSlugData>({
                    path: `/v1/organizations/${orgSlug}`,
                    method: 'DELETE',
                    ...params
                })
        ...
        postOrganizations: () => {
            ...
            return {
                ...
                request: (data: OrganizationsPostRequest, params: RequestParams = {}) => this.request<PostOrganizationsData>({
        ...
        patchResetInviteToken: () => {
            ...
            return {
                ...
                request: (orgSlug: string, params: RequestParams = {}) => this.request<PatchResetInviteTokenData>({
        ...
        postJoinByToken: () => {
            ...
            return {
                ...
                request: (orgSlug: string, token: string, params: RequestParams = {}) => this.request<PostJoinByTokenData>({
        ...
        putOnboard: () => {
            ...
            return {
                ...
                request: (orgSlug: string, params: RequestParams = {}) => this.request<PutOnboardData>({
        ...
        getAvatarPresignedFields: () => {
            ...
            return {
                ...
                requestKey: (params: GetAvatarPresignedFieldsParams) => dataTaggedQueryKey<GetAvatarPresignedFieldsData>([base, params]),
                request: ({ orgSlug, ...query }: GetAvatarPresignedFieldsParams, params: RequestParams = {}) => this.request<GetAvatarPresignedFieldsData>({
        ...
        deletePinsById: () => {
            ...
            return {
                ...
                request: (orgSlug: string, id: string, params: RequestParams = {}) => this.request<DeletePinsByIdData>({
        ...
        getPostsAttachmentsComments: () => {
            ...
            return {
                ...
                requestKey: (params: GetPostsAttachmentsCommentsParams) => dataTaggedQueryKey<GetPostsAttachmentsCommentsData>([base, params]),
                request: ({ orgSlug, postId, attachmentId, ...query }: GetPostsAttachmentsCommentsParams, params: RequestParams = {}) => this.request<GetPostsAttachmentsCommentsData>({
        ...
        putPostsAttachmentsReorder: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, postId: string) => dataTaggedQueryKey<PutPostsAttachmentsReorderData>([base, orgSlug, postId]),
                request: (orgSlug: string, postId: string, data: OrganizationsOrgSlugPostsPostIdAttachmentsReorderPutRequest, params: RequestParams = {}) => this.request<PutPostsAttachmentsReorderData>({
        ...
        postPostsAttachments: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, postId: string) => dataTaggedQueryKey<PostPostsAttachmentsData>([base, orgSlug, postId]),
                request: (orgSlug: string, postId: string, data: OrganizationPostAttachmentsPostRequest, params: RequestParams = {}) => this.request<PostPostsAttachmentsData>({
        ...
        putPostsAttachmentsById: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, postId: string, id: string) => dataTaggedQueryKey<PutPostsAttachmentsByIdData>([base, orgSlug, postId, id]),
                request: (orgSlug: string, postId: string, id: string, data: OrganizationsOrgSlugPostsPostIdAttachmentsIdPutRequest, params: RequestParams = {}) => this.request<PutPostsAttachmentsByIdData>({
        ...
        deletePostsAttachmentsById: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, postId: string, id: string) => dataTaggedQueryKey<DeletePostsAttachmentsByIdData>([base, orgSlug, postId, id]),
                request: (orgSlug: string, postId: string, id: string, params: RequestParams = {}) => this.request<DeletePostsAttachmentsByIdData>({
                    path: `/v1/organizations/${orgSlug}/posts/${postId}/attachments/${id}`,
                    method: 'DELETE',
                    ...params
                })
        ...
        postPostsFavorite: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, postId: string) => dataTaggedQueryKey<PostPostsFavoriteData>([base, orgSlug, postId]),
                request: (orgSlug: string, postId: string, params: RequestParams = {}) => this.request<PostPostsFavoriteData>({
        ...
        deletePostsFavorite: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, postId: string) => dataTaggedQueryKey<DeletePostsFavoriteData>([base, orgSlug, postId]),
                request: (orgSlug: string, postId: string, params: RequestParams = {}) => this.request<DeletePostsFavoriteData>({
                    path: `/v1/organizations/${orgSlug}/posts/${postId}/favorite`,
                    method: 'DELETE',
                    ...params
                })
        ...
        postPostsFeedbackDismissals: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, postId: string) => dataTaggedQueryKey<PostPostsFeedbackDismissalsData>([base, orgSlug, postId]),
                request: (orgSlug: string, postId: string, params: RequestParams = {}) => this.request<PostPostsFeedbackDismissalsData>({
        ...
        postPostsFollowUp: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, postId: string) => dataTaggedQueryKey<PostPostsFollowUpData>([base, orgSlug, postId]),
                request: (orgSlug: string, postId: string, data: OrganizationPostFollowUpPostRequest, params: RequestParams = {}) => this.request<PostPostsFollowUpData>({
        ...
        getPostsGeneratedResolution: () => {
            ...
            return {
                ...
                requestKey: (params: GetPostsGeneratedResolutionParams) => dataTaggedQueryKey<GetPostsGeneratedResolutionData>([base, params]),
                request: ({ orgSlug, postId, ...query }: GetPostsGeneratedResolutionParams, params: RequestParams = {}) => this.request<GetPostsGeneratedResolutionData>({
        ...
        getPostsGeneratedTldr: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, postId: string) => dataTaggedQueryKey<GetPostsGeneratedTldrData>([base, orgSlug, postId]),
                request: (orgSlug: string, postId: string, params: RequestParams = {}) => this.request<GetPostsGeneratedTldrData>({
        ...
        postPostsLinearIssues: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, postId: string) => dataTaggedQueryKey<PostPostsLinearIssuesData>([base, orgSlug, postId]),
                request: (orgSlug: string, postId: string, data: OrganizationPostLinearIssuesPostRequest, params: RequestParams = {}) => this.request<PostPostsLinearIssuesData>({
        ...
        getPostsLinearTimelineEvents: () => {
            ...
            return {
                ...
                requestKey: (params: GetPostsLinearTimelineEventsParams) => dataTaggedQueryKey<GetPostsLinearTimelineEventsData>([base, params]),
                request: ({ orgSlug, postId, ...query }: GetPostsLinearTimelineEventsParams, params: RequestParams = {}) => this.request<GetPostsLinearTimelineEventsData>({
        ...
        postPostsPin: () => {
            ...
            return {
                ...
                request: (orgSlug: string, postId: string, params: RequestParams = {}) => this.request<PostPostsPinData>({
        ...
        postPostsPoll2OptionsVote: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, postId: string, optionId: string) => dataTaggedQueryKey<PostPostsPoll2OptionsVoteData>([base, orgSlug, postId, optionId]),
                request: (orgSlug: string, postId: string, optionId: string, params: RequestParams = {}) => this.request<PostPostsPoll2OptionsVoteData>({
        ...
        postPostsPoll2: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, postId: string) => dataTaggedQueryKey<PostPostsPoll2Data>([base, orgSlug, postId]),
                request: (orgSlug: string, postId: string, data: OrganizationsOrgSlugPostsPostIdPoll2PostRequest, params: RequestParams = {}) => this.request<PostPostsPoll2Data>({
        ...
        putPostsPoll2: () => {
            ...
            return {
                ...
                request: (orgSlug: string, postId: string, data: OrganizationsOrgSlugPostsPostIdPoll2PutRequest, params: RequestParams = {}) => this.request<PutPostsPoll2Data>({
                    path: `/v1/organizations/${orgSlug}/posts/${postId}/poll2`,
                    method: 'PUT',
                    body: data,
                    type: ContentType.Json,
        ...
        deletePostsPoll2: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, postId: string) => dataTaggedQueryKey<DeletePostsPoll2Data>([base, orgSlug, postId]),
                request: (orgSlug: string, postId: string, params: RequestParams = {}) => this.request<DeletePostsPoll2Data>({
                    path: `/v1/organizations/${orgSlug}/posts/${postId}/poll2`,
                    method: 'DELETE',
                    ...params
                })
        ...
        getPostsCanvasComments: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, postId: string) => dataTaggedQueryKey<GetPostsCanvasCommentsData>([base, orgSlug, postId]),
                request: (orgSlug: string, postId: string, params: RequestParams = {}) => this.request<GetPostsCanvasCommentsData>({
        ...
        getPostsComments: () => {
            ...
            return {
                ...
                request: ({ orgSlug, postId, ...query }: GetPostsCommentsParams, params: RequestParams = {}) => this.request<GetPostsCommentsData>({
        ...
        postPostsComments2: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, postId: string) => dataTaggedQueryKey<PostPostsComments2Data>([base, orgSlug, postId]),
                request: (orgSlug: string, postId: string, data: OrganizationPostComments2PostRequest, params: RequestParams = {}) => this.request<PostPostsComments2Data>({
        ...
        postPostsFeedbackRequests: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, postId: string) => dataTaggedQueryKey<PostPostsFeedbackRequestsData>([base, orgSlug, postId]),
                request: (orgSlug: string, postId: string, data: OrganizationPostFeedbackRequestsPostRequest, params: RequestParams = {}) => this.request<PostPostsFeedbackRequestsData>({
        ...
        deletePostsFeedbackRequestsById: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, postId: string, id: string) => dataTaggedQueryKey<DeletePostsFeedbackRequestsByIdData>([base, orgSlug, postId, id]),
                request: (orgSlug: string, postId: string, id: string, params: RequestParams = {}) => this.request<DeletePostsFeedbackRequestsByIdData>({
        ...
        postPostsFeedbackRequestsDismissal: () => {
            const base = 'POST:/v1/organizations/{org_slug}/posts/{post_id}/feedback_requests/{feedback_request_id}/dismissal' as const;
            return {
                baseKey: dataTaggedQueryKey<PostPostsFeedbackRequestsDismissalData>([base]),
                requestKey: (orgSlug: string, postId: string, feedbackRequestId: string) => dataTaggedQueryKey<PostPostsFeedbackRequestsDismissalData>([base, orgSlug, postId, feedbackRequestId]),
                request: (orgSlug: string, postId: string, feedbackRequestId: string, params: RequestParams = {}) => this.request<PostPostsFeedbackRequestsDismissalData>({
        ...
        postPostsLinks: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, postId: string) => dataTaggedQueryKey<PostPostsLinksData>([base, orgSlug, postId]),
                request: (orgSlug: string, postId: string, data: OrganizationPostLinksPostRequest, params: RequestParams = {}) => this.request<PostPostsLinksData>({
        ...
        postPostsReactions: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, postId: string) => dataTaggedQueryKey<PostPostsReactionsData>([base, orgSlug, postId]),
                request: (orgSlug: string, postId: string, data: OrganizationPostReactionsPostRequest, params: RequestParams = {}) => this.request<PostPostsReactionsData>({
        ...
        getPostsVersions: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, postId: string) => dataTaggedQueryKey<GetPostsVersionsData>([base, orgSlug, postId]),
                request: (orgSlug: string, postId: string, params: RequestParams = {}) => this.request<GetPostsVersionsData>({
        ...
        postPostsVersions: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, postId: string) => dataTaggedQueryKey<PostPostsVersionsData>([base, orgSlug, postId]),
                request: (orgSlug: string, postId: string, params: RequestParams = {}) => this.request<PostPostsVersionsData>({
                    path: `/v1/organizations/${orgSlug}/posts/${postId}/versions`,
                    method: 'POST',
                    ...params
                })
        ...
        getPostsViews: () => {
            ...
            return {
                ...
                request: ({ orgSlug, postId, ...query }: GetPostsViewsParams, params: RequestParams = {}) => this.request<GetPostsViewsData>({
        ...
        postPostsViews: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, postId: string) => dataTaggedQueryKey<PostPostsViewsData>([base, orgSlug, postId]),
                request: (orgSlug: string, postId: string, data: OrganizationsOrgSlugPostsPostIdViewsPostRequest, params: RequestParams = {}) => this.request<PostPostsViewsData>({
                    path: `/v1/organizations/${orgSlug}/posts/${postId}/views`,
                    method: 'POST',
                    body: data,
                    type: ContentType.Json,
        ...
        postPostsPublication: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, postId: string) => dataTaggedQueryKey<PostPostsPublicationData>([base, orgSlug, postId]),
                request: (orgSlug: string, postId: string, params: RequestParams = {}) => this.request<PostPostsPublicationData>({
        ...
        postPostsResolution: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, postId: string) => dataTaggedQueryKey<PostPostsResolutionData>([base, orgSlug, postId]),
                request: (orgSlug: string, postId: string, data: OrganizationsOrgSlugPostsPostIdResolutionPostRequest, params: RequestParams = {}) => this.request<PostPostsResolutionData>({
        ...
        deletePostsResolution: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, postId: string) => dataTaggedQueryKey<DeletePostsResolutionData>([base, orgSlug, postId]),
                request: (orgSlug: string, postId: string, params: RequestParams = {}) => this.request<DeletePostsResolutionData>({
                    path: `/v1/organizations/${orgSlug}/posts/${postId}/resolution`,
                    method: 'DELETE',
                    ...params
                })
        ...
        getPostsSeoInfo: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, postId: string) => dataTaggedQueryKey<GetPostsSeoInfoData>([base, orgSlug, postId]),
                request: (orgSlug: string, postId: string, params: RequestParams = {}) => this.request<GetPostsSeoInfoData>({
        ...
        postPostsShares: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, postId: string) => dataTaggedQueryKey<PostPostsSharesData>([base, orgSlug, postId]),
                request: (orgSlug: string, postId: string, data: OrganizationPostSharesPostRequest, params: RequestParams = {}) => this.request<PostPostsSharesData>({
        ...
        putPostsStatus: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, postId: string) => dataTaggedQueryKey<PutPostsStatusData>([base, orgSlug, postId]),
                request: (orgSlug: string, postId: string, data: OrganizationsOrgSlugPostsPostIdStatusPutRequest, params: RequestParams = {}) => this.request<PutPostsStatusData>({
        ...
        putPostsTasks: () => {
            ...
            return {
                ...
                request: (orgSlug: string, postId: string, data: OrganizationsOrgSlugPostsPostIdTasksPutRequest, params: RequestParams = {}) => this.request<PutPostsTasksData>({
        ...
        getPostsTimelineEvents: () => {
            ...
            return {
                ...
                requestKey: (params: GetPostsTimelineEventsParams) => dataTaggedQueryKey<GetPostsTimelineEventsData>([base, params]),
                request: ({ orgSlug, postId, ...query }: GetPostsTimelineEventsParams, params: RequestParams = {}) => this.request<GetPostsTimelineEventsData>({
        ...
        putPostsVisibility: () => {
            ...
            return {
                ...
                request: (orgSlug: string, postId: string, data: OrganizationsOrgSlugPostsPostIdVisibilityPutRequest, params: RequestParams = {}) => this.request<any>({
        ...
        getPostsPollOptionsVoters: () => {
            ...
            return {
                ...
                requestKey: (params: GetPostsPollOptionsVotersParams) => dataTaggedQueryKey<GetPostsPollOptionsVotersData>([base, params]),
                request: ({ orgSlug, postId, pollOptionId, ...query }: GetPostsPollOptionsVotersParams, params: RequestParams = {}) => this.request<GetPostsPollOptionsVotersData>({
        ...
        getPosts: () => {
            ...
            return {
                ...
                request: ({ orgSlug, ...query }: GetPostsParams, params: RequestParams = {}) => this.request<GetPostsData>({
        ...
        postPosts: () => {
            ...
            return {
                ...
                request: (orgSlug: string, data: OrganizationsOrgSlugPostsPostRequest, params: RequestParams = {}) => this.request<PostPostsData>({
                    path: `/v1/organizations/${orgSlug}/posts`,
                    method: 'POST',
                    body: data,
                    type: ContentType.Json,
        ...
        getPostsByPostId: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, postId: string) => dataTaggedQueryKey<GetPostsByPostIdData>([base, orgSlug, postId]),
                request: (orgSlug: string, postId: string, params: RequestParams = {}) => this.request<GetPostsByPostIdData>({
        ...
        putPostsByPostId: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, postId: string) => dataTaggedQueryKey<PutPostsByPostIdData>([base, orgSlug, postId]),
                request: (orgSlug: string, postId: string, data: OrganizationsOrgSlugPostsPostIdPutRequest, params: RequestParams = {}) => this.request<PutPostsByPostIdData>({
                    path: `/v1/organizations/${orgSlug}/posts/${postId}`,
                    method: 'PUT',
                    body: data,
                    type: ContentType.Json,
        ...
        deletePostsByPostId: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, postId: string) => dataTaggedQueryKey<DeletePostsByPostIdData>([base, orgSlug, postId]),
                request: (orgSlug: string, postId: string, params: RequestParams = {}) => this.request<DeletePostsByPostIdData>({
                    path: `/v1/organizations/${orgSlug}/posts/${postId}`,
                    method: 'DELETE',
                    ...params
                })
        ...
        postPostsSubscribe: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, postId: string) => dataTaggedQueryKey<PostPostsSubscribeData>([base, orgSlug, postId]),
                request: (orgSlug: string, postId: string, params: RequestParams = {}) => this.request<PostPostsSubscribeData>({
        ...
        deletePostsUnsubscribe: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, postId: string) => dataTaggedQueryKey<DeletePostsUnsubscribeData>([base, orgSlug, postId]),
                request: (orgSlug: string, postId: string, params: RequestParams = {}) => this.request<DeletePostsUnsubscribeData>({
        ...
        getPostsPresignedFields: () => {
            ...
            return {
                ...
                requestKey: (params: GetPostsPresignedFieldsParams) => dataTaggedQueryKey<GetPostsPresignedFieldsData>([base, params]),
                request: ({ orgSlug, ...query }: GetPostsPresignedFieldsParams, params: RequestParams = {}) => this.request<GetPostsPresignedFieldsData>({
        ...
        putProjectMembershipsReorder: () => {
            ...
            return {
                ...
                request: (orgSlug: string, data: OrganizationsOrgSlugProjectMembershipsReorderPutRequest, params: RequestParams = {}) => this.request<PutProjectMembershipsReorderData>({
        ...
        getProjectMemberships: () => {
            ...
            return {
                ...
                request: (orgSlug: string, params: RequestParams = {}) => this.request<GetProjectMembershipsData>({
        ...
        getProjectsAddableMembers: () => {
            ...
            return {
                ...
                requestKey: (params: GetProjectsAddableMembersParams) => dataTaggedQueryKey<GetProjectsAddableMembersData>([base, params]),
                request: ({ orgSlug, projectId, ...query }: GetProjectsAddableMembersParams, params: RequestParams = {}) => this.request<GetProjectsAddableMembersData>({
        ...
        getProjectsBookmarks: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, projectId: string) => dataTaggedQueryKey<GetProjectsBookmarksData>([base, orgSlug, projectId]),
                request: (orgSlug: string, projectId: string, params: RequestParams = {}) => this.request<GetProjectsBookmarksData>({
        ...
        postProjectsBookmarks: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, projectId: string) => dataTaggedQueryKey<PostProjectsBookmarksData>([base, orgSlug, projectId]),
                request: (orgSlug: string, projectId: string, data: OrganizationsOrgSlugProjectsProjectIdBookmarksPostRequest, params: RequestParams = {}) => this.request<PostProjectsBookmarksData>({
                    path: `/v1/organizations/${orgSlug}/projects/${projectId}/bookmarks`,
                    method: 'POST',
                    body: data,
                    type: ContentType.Json,
        ...
        patchProjectsBookmarksById: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, projectId: string, id: string) => dataTaggedQueryKey<PatchProjectsBookmarksByIdData>([base, orgSlug, projectId, id]),
                request: (orgSlug: string, projectId: string, id: string, data: OrganizationsOrgSlugProjectsProjectIdBookmarksIdPatchRequest, params: RequestParams = {}) => this.request<PatchProjectsBookmarksByIdData>({
        ...
        deleteProjectsBookmarksById: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, projectId: string, id: string) => dataTaggedQueryKey<DeleteProjectsBookmarksByIdData>([base, orgSlug, projectId, id]),
                request: (orgSlug: string, projectId: string, id: string, params: RequestParams = {}) => this.request<DeleteProjectsBookmarksByIdData>({
                    path: `/v1/organizations/${orgSlug}/projects/${projectId}/bookmarks/${id}`,
                    method: 'DELETE',
                    ...params
                })
        ...
        putProjectsBookmarksReorder: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, projectId: string) => dataTaggedQueryKey<PutProjectsBookmarksReorderData>([base, orgSlug, projectId]),
                request: (orgSlug: string, projectId: string, data: OrganizationProjectBookmarksReorderPutRequest, params: RequestParams = {}) => this.request<PutProjectsBookmarksReorderData>({
        ...
        getProjectsCalls: () => {
            ...
            return {
                ...
                request: ({ orgSlug, projectId, ...query }: GetProjectsCallsParams, params: RequestParams = {}) => this.request<GetProjectsCallsData>({
        ...
        postProjectsDataExports: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, projectId: string) => dataTaggedQueryKey<PostProjectsDataExportsData>([base, orgSlug, projectId]),
                request: (orgSlug: string, projectId: string, params: RequestParams = {}) => this.request<PostProjectsDataExportsData>({
        ...
        putProjectsDisplayPreferences: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, projectId: string) => dataTaggedQueryKey<PutProjectsDisplayPreferencesData>([base, orgSlug, projectId]),
                request: (orgSlug: string, projectId: string, data: OrganizationsOrgSlugProjectsProjectIdDisplayPreferencesPutRequest, params: RequestParams = {}) => this.request<PutProjectsDisplayPreferencesData>({
        ...
        postProjectsFavorites: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, projectId: string) => dataTaggedQueryKey<PostProjectsFavoritesData>([base, orgSlug, projectId]),
                request: (orgSlug: string, projectId: string, params: RequestParams = {}) => this.request<PostProjectsFavoritesData>({
        ...
        deleteProjectsFavorites: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, projectId: string) => dataTaggedQueryKey<DeleteProjectsFavoritesData>([base, orgSlug, projectId]),
                request: (orgSlug: string, projectId: string, params: RequestParams = {}) => this.request<DeleteProjectsFavoritesData>({
                    path: `/v1/organizations/${orgSlug}/projects/${projectId}/favorites`,
                    method: 'DELETE',
                    ...params
                })
        ...
        postProjectsInvitationUrlAcceptances: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, projectId: string) => dataTaggedQueryKey<PostProjectsInvitationUrlAcceptancesData>([base, orgSlug, projectId]),
                request: (orgSlug: string, projectId: string, data: OrganizationProjectInvitationUrlAcceptancesPostRequest, params: RequestParams = {}) => this.request<PostProjectsInvitationUrlAcceptancesData>({
        ...
        postProjectsInvitationUrl: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, projectId: string) => dataTaggedQueryKey<PostProjectsInvitationUrlData>([base, orgSlug, projectId]),
                request: (orgSlug: string, projectId: string, params: RequestParams = {}) => this.request<PostProjectsInvitationUrlData>({
        ...
        getProjectsInvitationUrl: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, projectId: string) => dataTaggedQueryKey<GetProjectsInvitationUrlData>([base, orgSlug, projectId]),
                request: (orgSlug: string, projectId: string, params: RequestParams = {}) => this.request<GetProjectsInvitationUrlData>({
                    path: `/v1/organizations/${orgSlug}/projects/${projectId}/invitation_url`,
                    method: 'GET',
                    ...params
                })
        ...
        getProjectsMembers: () => {
            ...
            return {
                ...
                request: ({ orgSlug, projectId, ...query }: GetProjectsMembersParams, params: RequestParams = {}) => this.request<GetProjectsMembersData>({
        ...
        postProjectsMemberships: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, projectId: string) => dataTaggedQueryKey<PostProjectsMembershipsData>([base, orgSlug, projectId]),
                request: (orgSlug: string, projectId: string, data: OrganizationsOrgSlugProjectsProjectIdMembershipsPostRequest, params: RequestParams = {}) => this.request<PostProjectsMembershipsData>({
        ...
        deleteProjectsMemberships: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, projectId: string) => dataTaggedQueryKey<DeleteProjectsMembershipsData>([base, orgSlug, projectId]),
                request: (orgSlug: string, projectId: string, data: OrganizationProjectProjectMembershipsDeleteRequest, params: RequestParams = {}) => this.request<DeleteProjectsMembershipsData>({
                    path: `/v1/organizations/${orgSlug}/projects/${projectId}/memberships`,
                    method: 'DELETE',
                    body: data,
                    type: ContentType.Json,
        ...
        getProjectsNotes: () => {
            ...
            return {
                ...
                request: ({ orgSlug, projectId, ...query }: GetProjectsNotesParams, params: RequestParams = {}) => this.request<GetProjectsNotesData>({
        ...
        getProjectsOauthApplications: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, projectId: string) => dataTaggedQueryKey<GetProjectsOauthApplicationsData>([base, orgSlug, projectId]),
                request: (orgSlug: string, projectId: string, params: RequestParams = {}) => this.request<GetProjectsOauthApplicationsData>({
        ...
        postProjectsOauthApplications: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, projectId: string) => dataTaggedQueryKey<PostProjectsOauthApplicationsData>([base, orgSlug, projectId]),
                request: (orgSlug: string, projectId: string, data: OrganizationsOrgSlugProjectsProjectIdOauthApplicationsPostRequest, params: RequestParams = {}) => this.request<PostProjectsOauthApplicationsData>({
                    path: `/v1/organizations/${orgSlug}/projects/${projectId}/oauth_applications`,
                    method: 'POST',
                    body: data,
                    type: ContentType.Json,
        ...
        deleteProjectsOauthApplicationsById: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, projectId: string, id: string) => dataTaggedQueryKey<DeleteProjectsOauthApplicationsByIdData>([base, orgSlug, projectId, id]),
                request: (orgSlug: string, projectId: string, id: string, params: RequestParams = {}) => this.request<DeleteProjectsOauthApplicationsByIdData>({
        ...
        getProjectsPins: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, projectId: string) => dataTaggedQueryKey<GetProjectsPinsData>([base, orgSlug, projectId]),
                request: (orgSlug: string, projectId: string, params: RequestParams = {}) => this.request<GetProjectsPinsData>({
        ...
        getProjectsPosts: () => {
            ...
            return {
                ...
                request: ({ orgSlug, projectId, ...query }: GetProjectsPostsParams, params: RequestParams = {}) => this.request<GetProjectsPostsData>({
        ...
        postProjectsReads: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, projectId: string) => dataTaggedQueryKey<PostProjectsReadsData>([base, orgSlug, projectId]),
                request: (orgSlug: string, projectId: string, params: RequestParams = {}) => this.request<PostProjectsReadsData>({
        ...
        deleteProjectsReads: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, projectId: string) => dataTaggedQueryKey<DeleteProjectsReadsData>([base, orgSlug, projectId]),
                request: (orgSlug: string, projectId: string, params: RequestParams = {}) => this.request<DeleteProjectsReadsData>({
                    path: `/v1/organizations/${orgSlug}/projects/${projectId}/reads`,
                    method: 'DELETE',
                    ...params
                })
        ...
        postProjectsSubscription: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, projectId: string) => dataTaggedQueryKey<PostProjectsSubscriptionData>([base, orgSlug, projectId]),
                request: (orgSlug: string, projectId: string, data: OrganizationsOrgSlugProjectsProjectIdSubscriptionPostRequest, params: RequestParams = {}) => this.request<PostProjectsSubscriptionData>({
        ...
        deleteProjectsSubscription: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, projectId: string) => dataTaggedQueryKey<DeleteProjectsSubscriptionData>([base, orgSlug, projectId]),
                request: (orgSlug: string, projectId: string, params: RequestParams = {}) => this.request<DeleteProjectsSubscriptionData>({
                    path: `/v1/organizations/${orgSlug}/projects/${projectId}/subscription`,
                    method: 'DELETE',
                    ...params
                })
        ...
        putProjectsViewerDisplayPreferences: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, projectId: string) => dataTaggedQueryKey<PutProjectsViewerDisplayPreferencesData>([base, orgSlug, projectId]),
                request: (orgSlug: string, projectId: string, data: OrganizationsOrgSlugProjectsProjectIdViewerDisplayPreferencesPutRequest, params: RequestParams = {}) => this.request<PutProjectsViewerDisplayPreferencesData>({
        ...
        deleteProjectsViewerDisplayPreferences: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, projectId: string) => dataTaggedQueryKey<DeleteProjectsViewerDisplayPreferencesData>([base, orgSlug, projectId]),
                request: (orgSlug: string, projectId: string, params: RequestParams = {}) => this.request<DeleteProjectsViewerDisplayPreferencesData>({
                    path: `/v1/organizations/${orgSlug}/projects/${projectId}/viewer_display_preferences`,
                    method: 'DELETE',
                    ...params
                })
        ...
        postProjectsViews: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, projectId: string) => dataTaggedQueryKey<PostProjectsViewsData>([base, orgSlug, projectId]),
                request: (orgSlug: string, projectId: string, params: RequestParams = {}) => this.request<PostProjectsViewsData>({
        ...
        getProjects: () => {
            ...
            return {
                ...
                request: ({ orgSlug, ...query }: GetProjectsParams, params: RequestParams = {}) => this.request<GetProjectsData>({
        ...
        postProjects: () => {
            ...
            return {
                ...
                request: (orgSlug: string, data: OrganizationsOrgSlugProjectsPostRequest, params: RequestParams = {}) => this.request<PostProjectsData>({
                    path: `/v1/organizations/${orgSlug}/projects`,
                    method: 'POST',
                    body: data,
                    type: ContentType.Json,
        ...
        getProjectsByProjectId: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, projectId: string) => dataTaggedQueryKey<GetProjectsByProjectIdData>([base, orgSlug, projectId]),
                request: (orgSlug: string, projectId: string, params: RequestParams = {}) => this.request<GetProjectsByProjectIdData>({
        ...
        putProjectsByProjectId: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, projectId: string) => dataTaggedQueryKey<PutProjectsByProjectIdData>([base, orgSlug, projectId]),
                request: (orgSlug: string, projectId: string, data: OrganizationsOrgSlugProjectsProjectIdPutRequest, params: RequestParams = {}) => this.request<PutProjectsByProjectIdData>({
                    path: `/v1/organizations/${orgSlug}/projects/${projectId}`,
                    method: 'PUT',
                    body: data,
                    type: ContentType.Json,
        ...
        deleteProjectsByProjectId: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, projectId: string) => dataTaggedQueryKey<DeleteProjectsByProjectIdData>([base, orgSlug, projectId]),
                request: (orgSlug: string, projectId: string, params: RequestParams = {}) => this.request<DeleteProjectsByProjectIdData>({
                    path: `/v1/organizations/${orgSlug}/projects/${projectId}`,
                    method: 'DELETE',
                    ...params
                })
        ...
        patchProjectsArchive: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, projectId: string) => dataTaggedQueryKey<PatchProjectsArchiveData>([base, orgSlug, projectId]),
                request: (orgSlug: string, projectId: string, params: RequestParams = {}) => this.request<PatchProjectsArchiveData>({
        ...
        patchProjectsUnarchive: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, projectId: string) => dataTaggedQueryKey<PatchProjectsUnarchiveData>([base, orgSlug, projectId]),
                request: (orgSlug: string, projectId: string, params: RequestParams = {}) => this.request<PatchProjectsUnarchiveData>({
        ...
        getProjectCoverPhotoPresignedFields: () => {
            ...
            return {
                ...
                requestKey: (params: GetProjectCoverPhotoPresignedFieldsParams) => dataTaggedQueryKey<GetProjectCoverPhotoPresignedFieldsData>([base, params]),
                request: ({ orgSlug, ...query }: GetProjectCoverPhotoPresignedFieldsParams, params: RequestParams = {}) => this.request<GetProjectCoverPhotoPresignedFieldsData>({
        ...
        deleteReactions: () => {
            ...
            return {
                ...
                request: (orgSlug: string, data: OrganizationReactionsDeleteRequest, params: RequestParams = {}) => this.request<DeleteReactionsData>({
        ...
        getResourceMentions: () => {
            ...
            return {
                ...
                request: ({ orgSlug, ...query }: GetResourceMentionsParams, params: RequestParams = {}) => this.request<GetResourceMentionsData>({
        ...
        getSearchGroups: () => {
            ...
            return {
                ...
                request: ({ orgSlug, ...query }: GetSearchGroupsParams, params: RequestParams = {}) => this.request<GetSearchGroupsData>({
        ...
        getSearchMixed: () => {
            ...
            return {
                ...
                request: ({ orgSlug, ...query }: GetSearchMixedParams, params: RequestParams = {}) => this.request<GetSearchMixedData>({
        ...
        getSearchPosts: () => {
            ...
            return {
                ...
                request: ({ orgSlug, ...query }: GetSearchPostsParams, params: RequestParams = {}) => this.request<GetSearchPostsData>({
        ...
        getSearchResourceMentions: () => {
            ...
            return {
                ...
                requestKey: (params: GetSearchResourceMentionsParams) => dataTaggedQueryKey<GetSearchResourceMentionsData>([base, params]),
                request: ({ orgSlug, ...query }: GetSearchResourceMentionsParams, params: RequestParams = {}) => this.request<GetSearchResourceMentionsData>({
        ...
        getIntegrationsSlack: () => {
            ...
            return {
                ...
                request: (orgSlug: string, params: RequestParams = {}) => this.request<GetIntegrationsSlackData>({
        ...
        deleteIntegrationsSlack: () => {
            ...
            return {
                ...
                request: (orgSlug: string, params: RequestParams = {}) => this.request<DeleteIntegrationsSlackData>({
                    path: `/v1/organizations/${orgSlug}/integrations/slack`,
                    method: 'DELETE',
                    ...params
                })
        ...
        getSyncCustomReactions: () => {
            ...
            return {
                ...
                request: (orgSlug: string, params: RequestParams = {}) => this.request<GetSyncCustomReactionsData>({
        ...
        getSyncMembers: () => {
            ...
            return {
                ...
                request: (orgSlug: string, params: RequestParams = {}) => this.request<GetSyncMembersData>({
        ...
        getSyncMessageThreads: () => {
            ...
            return {
                ...
                request: (orgSlug: string, params: RequestParams = {}) => this.request<GetSyncMessageThreadsData>({
        ...
        getSyncProjects: () => {
            ...
            return {
                ...
                request: (orgSlug: string, params: RequestParams = {}) => this.request<GetSyncProjectsData>({
        ...
        getSyncTags: () => {
            ...
            return {
                ...
                request: (orgSlug: string, params: RequestParams = {}) => this.request<GetSyncTagsData>({
        ...
        getTags: () => {
            ...
            return {
                ...
                request: ({ orgSlug, ...query }: GetTagsParams, params: RequestParams = {}) => this.request<GetTagsData>({
        ...
        postTags: () => {
            ...
            return {
                ...
                request: (orgSlug: string, data: OrganizationsOrgSlugTagsPostRequest, params: RequestParams = {}) => this.request<PostTagsData>({
                    path: `/v1/organizations/${orgSlug}/tags`,
                    method: 'POST',
                    body: data,
                    type: ContentType.Json,
        ...
        getTagsByTagName: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, tagName: string) => dataTaggedQueryKey<GetTagsByTagNameData>([base, orgSlug, tagName]),
                request: (orgSlug: string, tagName: string, params: RequestParams = {}) => this.request<GetTagsByTagNameData>({
        ...
        patchTagsByTagName: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, tagName: string) => dataTaggedQueryKey<PatchTagsByTagNameData>([base, orgSlug, tagName]),
                request: (orgSlug: string, tagName: string, data: OrganizationsOrgSlugTagsTagNamePatchRequest, params: RequestParams = {}) => this.request<PatchTagsByTagNameData>({
                    path: `/v1/organizations/${orgSlug}/tags/${tagName}`,
                    method: 'PATCH',
                    body: data,
                    type: ContentType.Json,
        ...
        deleteTagsByTagName: () => {
            ...
            return {
                ...
                requestKey: (orgSlug: string, tagName: string) => dataTaggedQueryKey<DeleteTagsByTagNameData>([base, orgSlug, tagName]),
                request: (orgSlug: string, tagName: string, params: RequestParams = {}) => this.request<DeleteTagsByTagNameData>({
                    path: `/v1/organizations/${orgSlug}/tags/${tagName}`,
                    method: 'DELETE',
                    ...params
                })
        ...
        getTagsPosts: () => {
            ...
            return {
                ...
                request: ({ orgSlug, tagName, ...query }: GetTagsPostsParams, params: RequestParams = {}) => this.request<GetTagsPostsData>({
    ...
    batchedPostViews = {
        ...
        postBatchedPostViews: () => {
            ...
            return {
                ...
                request: (data: BatchedPostViewsPostRequest, params: RequestParams = {}) => this.request<PostBatchedPostViewsData>({
    ...
    imageUrls = {
        ...
        postImageUrls: () => {
            ...
            return {
                ...
                request: (data: ImageUrlsPostRequest, params: RequestParams = {}) => this.request<PostImageUrlsData>({
                    path: `/v1/image_urls`,
                    method: 'POST',
                    body: data,
                    type: ContentType.Json,
    ...
    integrations = {
        ...
        postIntegrationsCalDotComCallRooms: () => {
            ...
            return {
                ...
                request: (params: RequestParams = {}) => this.request<PostIntegrationsCalDotComCallRoomsData>({
        ...
        getIntegrationsCalDotComIntegration: () => {
            ...
            return {
                ...
                request: (params: RequestParams = {}) => this.request<GetIntegrationsCalDotComIntegrationData>({
        ...
        putIntegrationsCalDotComOrganization: () => {
            ...
            return {
                ...
                request: (data: IntegrationsCalDotComOrganizationPutRequest, params: RequestParams = {}) => this.request<PutIntegrationsCalDotComOrganizationData>({
        ...
        getIntegrationsFigmaIntegration: () => {
            ...
            return {
                ...
                request: (params: RequestParams = {}) => this.request<GetIntegrationsFigmaIntegrationData>({
        ...
        postIntegrationsZapierComments: () => {
            ...
            return {
                ...
                request: (data: ZapierIntegrationCommentsPostRequest, params: RequestParams = {}) => this.request<PostIntegrationsZapierCommentsData>({
        ...
        postIntegrationsZapierMessages: () => {
            ...
            return {
                ...
                request: (data: ZapierIntegrationMessagesPostRequest, params: RequestParams = {}) => this.request<PostIntegrationsZapierMessagesData>({
        ...
        postIntegrationsZapierPosts: () => {
            ...
            return {
                ...
                request: (data: ZapierIntegrationPostsPostRequest, params: RequestParams = {}) => this.request<PostIntegrationsZapierPostsData>({
        ...
        getIntegrationsZapierProjects: () => {
            ...
            return {
                ...
                requestKey: (params: GetIntegrationsZapierProjectsParams) => dataTaggedQueryKey<GetIntegrationsZapierProjectsData>([base, params]),
                request: (query: GetIntegrationsZapierProjectsParams, params: RequestParams = {}) => this.request<GetIntegrationsZapierProjectsData>({
    ...
    openGraphLinks = {
        ...
        getOpenGraphLinks: () => {
            ...
            return {
                ...
                request: (query: GetOpenGraphLinksParams, params: RequestParams = {}) => this.request<GetOpenGraphLinksData>({
    ...
    invitationsByToken = {
        ...
        postInvitationsByTokenAccept: () => {
            ...
            return {
                ...
                request: (inviteToken: string, params: RequestParams = {}) => this.request<PostInvitationsByTokenAcceptData>({
    ...
    organizationMemberships = {
        ...
        putOrganizationMembershipsReorder: () => {
            ...
            return {
                ...
                request: (data: OrganizationMembershipsReorderPutRequest, params: RequestParams = {}) => this.request<PutOrganizationMembershipsReorderData>({
        ...
        getOrganizationMemberships: () => {
            ...
            return {
                ...
                request: (params: RequestParams = {}) => this.request<GetOrganizationMembershipsData>({
    ...
    productLogs = {
        ...
        postProductLogs: () => {
            ...
            return {
                ...
                request: (data: ProductLogsPostRequest, params: RequestParams = {}) => this.request<PostProductLogsData>({
    ...
    organizationByToken = {
        ...
        getOrganizationByToken: () => {
            ...
            return {
                ...
                request: (token: string, params: RequestParams = {}) => this.request<GetOrganizationByTokenData>({
    ...
    publicProjects = {
        ...
        getPublicProjectsByToken: () => {
            ...
            return {
                ...
                request: (token: string, params: RequestParams = {}) => this.request<GetPublicProjectsByTokenData>({
    ...
    signIn = {
        ...
        postSignInDesktop: () => {
            ...
            return {
                ...
                request: (data: InternalDesktopSessionPostRequest, params: RequestParams = {}) => this.request<PostSignInDesktopData>({
    ...
    users = {
        ...
        postMeSyncToken: () => {
            ...
            return {
                ...
                request: (params: RequestParams = {}) => this.request<PostMeSyncTokenData>({
        ...
        postMeNotificationPause: () => {
            ...
            return {
                ...
                request: (data: UsersMeNotificationPausePostRequest, params: RequestParams = {}) => this.request<PostMeNotificationPauseData>({
        ...
        deleteMeNotificationPause: () => {
            ...
            return {
                ...
                request: (params: RequestParams = {}) => this.request<DeleteMeNotificationPauseData>({
                    path: `/v1/users/me/notification_pause`,
                    method: 'DELETE',
                    ...params
                })
        ...
        getMeNotificationSchedule: () => {
            ...
            return {
                ...
                request: (params: RequestParams = {}) => this.request<GetMeNotificationScheduleData>({
        ...
        putMeNotificationSchedule: () => {
            ...
            return {
                ...
                request: (data: UsersMeNotificationSchedulePutRequest, params: RequestParams = {}) => this.request<PutMeNotificationScheduleData>({
                    path: `/v1/users/me/notification_schedule`,
                    method: 'PUT',
                    body: data,
                    type: ContentType.Json,
        ...
        deleteMeNotificationSchedule: () => {
            ...
            return {
                ...
                request: (params: RequestParams = {}) => this.request<DeleteMeNotificationScheduleData>({
                    path: `/v1/users/me/notification_schedule`,
                    method: 'DELETE',
                    ...params
                })
        ...
        getMeNotificationsUnreadAllCount: () => {
            ...
            return {
                ...
                request: (params: RequestParams = {}) => this.request<GetMeNotificationsUnreadAllCountData>({
        ...
        getMeOrganizationInvitations: () => {
            ...
            return {
                ...
                request: (params: RequestParams = {}) => this.request<GetMeOrganizationInvitationsData>({
        ...
        putMePreference: () => {
            ...
            return {
                ...
                request: (data: UsersMePreferencePutRequest, params: RequestParams = {}) => this.request<PutMePreferenceData>({
        ...
        getMeScheduledNotifications: () => {
            ...
            return {
                ...
                request: (params: RequestParams = {}) => this.request<GetMeScheduledNotificationsData>({
        ...
        postMeScheduledNotifications: () => {
            ...
            return {
                ...
                request: (data: UsersMeScheduledNotificationsPostRequest, params: RequestParams = {}) => this.request<PostMeScheduledNotificationsData>({
                    path: `/v1/users/me/scheduled-notifications`,
                    method: 'POST',
                    body: data,
                    type: ContentType.Json,
        ...
        putMeScheduledNotificationsById: () => {
            ...
            return {
                ...
                request: (id: string, data: CurrentUserScheduledNotificationPutRequest, params: RequestParams = {}) => this.request<PutMeScheduledNotificationsByIdData>({
        ...
        deleteMeScheduledNotificationsById: () => {
            ...
            return {
                ...
                request: (id: string, params: RequestParams = {}) => this.request<DeleteMeScheduledNotificationsByIdData>({
                    path: `/v1/users/me/scheduled-notifications/${id}`,
                    method: 'DELETE',
                    ...params
                })
        ...
        deleteMeSignOut: () => {
            ...
            return {
                ...
                request: (params: RequestParams = {}) => this.request<DeleteMeSignOutData>({
        ...
        getMeSuggestedOrganizations: () => {
            ...
            return {
                ...
                request: (params: RequestParams = {}) => this.request<GetMeSuggestedOrganizationsData>({
        ...
        postMeTimezone: () => {
            ...
            return {
                ...
                request: (data: UsersTimezonePostRequest, params: RequestParams = {}) => this.request<PostMeTimezoneData>({
        ...
        postMeTwoFactorAuthentication: () => {
            ...
            return {
                ...
                request: (params: RequestParams = {}) => this.request<PostMeTwoFactorAuthenticationData>({
        ...
        putMeTwoFactorAuthentication: () => {
            ...
            return {
                ...
                request: (data: UsersMeTwoFactorAuthenticationPutRequest, params: RequestParams = {}) => this.request<PutMeTwoFactorAuthenticationData>({
                    path: `/v1/users/me/two-factor-authentication`,
                    method: 'PUT',
                    body: data,
                    type: ContentType.Json,
        ...
        deleteMeTwoFactorAuthentication: () => {
            ...
            return {
                ...
                request: (data: UsersMeTwoFactorAuthenticationDeleteRequest, params: RequestParams = {}) => this.request<DeleteMeTwoFactorAuthenticationData>({
                    path: `/v1/users/me/two-factor-authentication`,
                    method: 'DELETE',
                    body: data,
                    type: ContentType.Json,
        ...
        getMe: () => {
            ...
            return {
                ...
                request: (params: RequestParams = {}) => this.request<GetMeData>({
                    path: `/v1/users/me`,
                    method: 'GET',
                    ...params
                })
        ...
        patchMe: () => {
            ...
            return {
                ...
                request: (data: UsersMePatchRequest, params: RequestParams = {}) => this.request<PatchMeData>({
                    path: `/v1/users/me`,
                    method: 'PATCH',
                    body: data,
                    type: ContentType.Json,
        ...
        putMeOnboard: () => {
            ...
            return {
                ...
                request: (params: RequestParams = {}) => this.request<PutMeOnboardData>({
        ...
        postMeSendEmailConfirmation: () => {
            ...
            return {
                ...
                request: (params: RequestParams = {}) => this.request<PostMeSendEmailConfirmationData>({
        ...
        getMeAvatarPresignedFields: () => {
            ...
            return {
                ...
                requestKey: (params: GetMeAvatarPresignedFieldsParams) => dataTaggedQueryKey<GetMeAvatarPresignedFieldsData>([base, params]),
                request: (query: GetMeAvatarPresignedFieldsParams, params: RequestParams = {}) => this.request<GetMeAvatarPresignedFieldsData>({
        ...
        getMeCoverPhotoPresignedFields: () => {
            ...
            return {
                ...
                requestKey: (params: GetMeCoverPhotoPresignedFieldsParams) => dataTaggedQueryKey<GetMeCoverPhotoPresignedFieldsData>([base, params]),
                request: (query: GetMeCoverPhotoPresignedFieldsParams, params: RequestParams = {}) => this.request<GetMeCoverPhotoPresignedFieldsData>({
    ...
    pushSubscriptions = {
        ...
        postPushSubscriptions: () => {
            ...
            return {
                ...
                request: (data: WebPushSubscriptionsPostRequest, params: RequestParams = {}) => this.request<PostPushSubscriptionsData>({
    ...
    members = {
        ...
        postMembersMessagesV2: () => {
            ...
            return {
                ...
                request: (memberId: string, data: V2MemberMessagesPostRequest, params: RequestParams = {}) => this.request<PostMembersMessagesV2Data>({
        ...
        getMembersV2: () => {
            ...
            return {
                ...
                request: (query: GetMembersV2Params, params: RequestParams = {}) => this.request<GetMembersV2Data>({
                    path: `/v2/members`,
                    method: 'GET',
                    query: query,
                    ...params
    ...
    posts = {
        ...
        getPostsCommentsV2: () => {
            ...
            return {
                ...
                request: ({ postId, ...query }: GetPostsCommentsV2Params, params: RequestParams = {}) => this.request<GetPostsCommentsV2Data>({
        ...
        postPostsCommentsV2: () => {
            ...
            return {
                ...
                request: (postId: string, data: V2PostsPostIdCommentsPostRequest, params: RequestParams = {}) => this.request<PostPostsCommentsV2Data>({
                    path: `/v2/posts/${postId}/comments`,
                    method: 'POST',
                    body: data,
                    type: ContentType.Json,
        ...
        postPostsResolutionV2: () => {
            ...
            return {
                ...
                request: (postId: string, data: V2PostsPostIdResolutionPostRequest, params: RequestParams = {}) => this.request<PostPostsResolutionV2Data>({
        ...
        deletePostsResolutionV2: () => {
            ...
            return {
                ...
                request: (postId: string, params: RequestParams = {}) => this.request<DeletePostsResolutionV2Data>({
                    path: `/v2/posts/${postId}/resolution`,
                    method: 'DELETE',
                    ...params
                })
        ...
        getPostsV2: () => {
            ...
            return {
                ...
                request: (query: GetPostsV2Params, params: RequestParams = {}) => this.request<GetPostsV2Data>({
                    path: `/v2/posts`,
                    method: 'GET',
                    query: query,
                    ...params
        ...
        postPostsV2: () => {
            ...
            return {
                ...
                request: (data: V2PostsPostRequest, params: RequestParams = {}) => this.request<PostPostsV2Data>({
                    path: `/v2/posts`,
                    method: 'POST',
                    body: data,
                    type: ContentType.Json,
        ...
        getPostsByIdV2: () => {
            ...
            return {
                ...
                request: (id: string, params: RequestParams = {}) => this.request<GetPostsByIdV2Data>({
                    path: `/v2/posts/${id}`,
                    method: 'GET',
                    ...params
                })
    ...
    channels = {
        ...
        getChannelsV2: () => {
            ...
            return {
                ...
                request: (query: GetChannelsV2Params, params: RequestParams = {}) => this.request<GetChannelsV2Data>({
                    path: `/v2/channels`,
                    method: 'GET',
                    query: query,
                    ...params
    ...
    threads = {
        ...
        getThreadsMessagesV2: () => {
            ...
            return {
                ...
                requestKey: (params: GetThreadsMessagesV2Params) => dataTaggedQueryKey<GetThreadsMessagesV2Data>([base, params]),
                request: ({ threadId, ...query }: GetThreadsMessagesV2Params, params: RequestParams = {}) => this.request<GetThreadsMessagesV2Data>({
        ...
        postThreadsMessagesV2: () => {
            ...
            return {
                ...
                request: (threadId: string, data: V2ThreadsThreadIdMessagesPostRequest, params: RequestParams = {}) => this.request<PostThreadsMessagesV2Data>({
                    path: `/v2/threads/${threadId}/messages`,
                    method: 'POST',
                    body: data,
                    type: ContentType.Json,
        ...
        postThreadsV2: () => {
            ...
            return {
                ...
                request: (data: V2ThreadsPostRequest, params: RequestParams = {}) => this.request<PostThreadsV2Data>({
                    path: `/v2/threads`,
                    method: 'POST',
                    body: data,
                    type: ContentType.Json,
    ...
    figma = {
        ...
        postSignInFigma: () => {
            ...
            return {
                ...
                request: (params: RequestParams = {}) => this.request<PostSignInFigmaData>({
                    path: `/sign-in/figma`,
                    method: 'POST',
                    ...params
                })
