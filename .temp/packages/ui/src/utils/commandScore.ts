...
function commandScoreInner(value: string, abbreviation: string, lowerString: string, lowerAbbreviation: string, stringIndex: number, abbreviationIndex: number, memoizedResults: {
    [key: string]: number;
}) {
