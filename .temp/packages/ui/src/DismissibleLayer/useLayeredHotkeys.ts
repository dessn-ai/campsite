...
import { useIsTopLayer } from "./index.tsx";
export interface LayeredHotkeysProps {
    keys: Keys;
    callback: HotkeyCallback;
    options?: Options & {
        repeat?: boolean;
        skipEscapeWhenDisabled?: boolean;
    };
 ...
 */
export function useLayeredHotkeys({ keys, callback, options: { repeat, skipEscapeWhenDisabled, ...options } = {}, dependencies }: LayeredHotkeysProps) {
...
export function useOrderedLayeredHotkeys({ keys, callback, options = {} }: {
