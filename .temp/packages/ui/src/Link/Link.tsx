...
import { WEB_URL } from "../../../config/src/index.ts";
import { useIsDesktopApp } from "../hooks/index.tsx";
import { cn } from "../utils/index.ts";
import { desktopJoinCall, linkType } from "./utils.ts";
...
export const Link = forwardRef<HTMLAnchorElement, LinkProps>((props, ref) => {
    ...
    const desktopOnClickOverride = isDesktopApp && (type === 'call' || type === 'desktop_oauth' || type === 'public_share');
    ...
    return (<NextLink {...rest} ref={ref} href={cleanedHref} className={classes} target={replaceInternalHref ? '_self' : props.target} onClick={(e) => {
