...
export const RelativeTime = React.forwardRef<RelativeTimeElement, RelativeTimeProps>(({ time, className, ...props }, ref) => {
    ...
    return (<span ref={ref} className={cn('whitespace-nowrap', className)} {...props}>
