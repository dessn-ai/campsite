...
export function AvatarNotificationReasonClip({ size, clipId }: ClipProps) {
    switch (size) {
        ...
        case 'lg': {
            return (<svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
          <clipPath id={clipId}>
            <path fillRule='evenodd' clipRule='evenodd' d='M39.5623 15.8188C39.9007 17.41 38.1473 18.5037 36.5816 18.062C35.2839 17.6959 33.9148 17.5 32.5 17.5C24.2157 17.5 17.5 24.2157 17.5 32.5C17.5 33.9148 17.6959 35.2839 18.062 36.5816C18.5037 38.1473 17.41 39.9007 15.8189 39.5623C6.78029 37.6398 0 29.6117 0 20C0 8.9543 8.9543 0 20 0C29.6117 0 37.6398 6.78029 39.5623 15.8188Z'/>
          </clipPath>
        </svg>);
        }
    }
