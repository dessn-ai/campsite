...
import { isMarkActiveInRange } from "../utils/isMarkActiveInRange.ts";
import { isNodeActiveInRange } from "../utils/isNodeActiveInRange.ts";
        ...
        return [
            new InputRule({
                ...
                handler: ({ state, range, match }) => {
                    ...
                    const timestamp = new Date(now.getFullYear(), now.getMonth(), now.getDate(), parsedHours, parsedMinutes).getTime();
