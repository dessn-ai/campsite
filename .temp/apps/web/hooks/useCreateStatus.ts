...
import { OrganizationMember, OrganizationsOrgSlugMembersMeStatusesPostRequest } from "../../../packages/types/index.ts";
...
export function useCreateStatus() {
    ...
    return useOptimisticMutation({
        mutationFn: ({ org, ...params }: CreateStatusParams) => apiClient.organizations.postMembersMeStatuses().request(org, {
            ...params,
