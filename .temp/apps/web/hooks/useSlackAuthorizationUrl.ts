import { DEV_SLACKBOT_CLIENT_ID, SLACKBOT_CLIENT_ID } from "../lib/slack.ts";
import { v4 as uuid } from 'uuid';
import { useCurrentUserHasFeature } from "./useCurrentUserHasFeature.ts";
export const useSlackAuthorizationUrl = ({ scopes, redirectUri, teamId }: {
    scopes: string[];
    redirectUri: string;
    teamId?: string | null;
}) => {
