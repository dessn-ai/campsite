...
import { UsersMeNotificationSchedulePutRequest } from "../../../packages/types/index.ts";
...
export function useUpdateNotificationSchedule() {
    ...
    return useMutation({
        mutationFn: (data: UsersMeNotificationSchedulePutRequest) => apiClient.users.putMeNotificationSchedule().request(data),
        onMutate: (data) => {
