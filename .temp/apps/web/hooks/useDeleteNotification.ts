...
import { Notification, OrganizationNotificationDeleteRequest, PublicOrganization } from "../../../packages/types/index.ts";
...
export function useDeleteNotification({ organization }: {
    ...
    return useMutation({
        mutationFn: ({ notification, archiveBy }: DeleteNotificationMutationVariables) => apiClient.organizations
