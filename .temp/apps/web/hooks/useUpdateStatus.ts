...
import { OrganizationMember, OrganizationsOrgSlugMembersMeStatusesPutRequest } from "../../../packages/types/index.ts";
import { apiClient, getTypedQueryData } from "../utils/queryClient.ts";
import { getExpiration } from "./useCreateStatus.ts";
...
export function useUpdateStatus() {
    ...
    return useOptimisticMutation({
        mutationFn: ({ org, ...params }: UpdateStatusParams) => apiClient.organizations.putMembersMeStatuses().request(org, {
            ...params,
