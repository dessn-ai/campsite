...
import { OrganizationMember, OrganizationMembershipStatus } from "../../../packages/types/index.ts";
        ...
        optimisticFns: ({ org }) => {
            ...
            return [
                ...
                },
                {
                    ...
                    updater: (old: OrganizationMembershipStatus[]): OrganizationMembershipStatus[] => uniqBy(filter([currentMember.status, ...old], isTruthy), (s) => s.message)
                }
            ];
        }
    });
