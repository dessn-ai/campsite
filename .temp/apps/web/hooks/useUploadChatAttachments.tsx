...
import { addAttachmentAtom, updateAttachmentAtom } from "../components/Chat/atoms.tsx";
import { useScope } from "../contexts/scope.tsx";
import { useGetCurrentOrganization } from "./useGetCurrentOrganization.ts";
import { useUploadHelpers } from "./useUploadHelpers.ts";
...
export function useUploadChatAttachments(props?: Props) {
    ...
    return useUploadHelpers({
        ...
        upload: (files: File[]) => createFileUploadPipeline({
            files,
            maxFileSize,
            scope: `${scope}`,
