...
import { UserNotificationCounts } from "../../../packages/types/index.ts";
import { useIsDesktopApp } from "../../../packages/ui/src/hooks/index.tsx";
import { setFaviconBadgeAtom } from "../components/Providers/MetaTags.tsx";
...
export function useUpdateBadgeCount() {
    ...
    const fn = useCallback((counts: UserNotificationCounts) => {
