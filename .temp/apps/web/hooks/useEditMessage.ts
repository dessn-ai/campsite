...
import { MessagePage, OrganizationsOrgSlugThreadsThreadIdMessagesIdPutRequest } from "../../../packages/types/index.ts";
...
export function useEditMessage() {
    ...
    return useOptimisticMutation({
        mutationFn: ({ threadId, messageId, ...params }: UseEditMessageInput) => apiClient.organizations.putThreadsMessagesById().request(`${scope}`, threadId, messageId, params),
        optimisticFns: (props) => [
            {
                query: {
