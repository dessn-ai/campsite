...
import { selectedCanvasCommentIdAtom } from "../components/CanvasComments/CanvasComments.tsx";
...
export function useResolveComment() {
    ...
    return useMutation({
        mutationFn: ({ commentId }: Props) => apiClient.organizations.postCommentsResolutions().request(`${scope}`, commentId),
        onSuccess: () => {
