...
import { OrganizationPostLinearIssuesPostRequest, PostPostsLinearIssuesData } from "../../../packages/types/index.ts";
...
export function useCreatePostLinearIssue({ postId, onStatusChange }: {
    postId: string;
    ...
    const updateOnStatusChange = useCallback((data: PostPostsLinearIssuesData) => {
