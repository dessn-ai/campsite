...
import { OrganizationNotificationDeleteAllPostRequest, PublicOrganization } from "../../../packages/types/index.ts";
...
export function useDeleteAllNotifications({ organization }: Options = {}) {
    ...
    return useMutation({
        mutationFn: (data: OrganizationNotificationDeleteAllPostRequest) => apiClient.organizations.postMembersMeNotificationsDeleteAll().request(orgSlug, data || {}),
