...
import { useSyncedProjects } from "./useSyncedProjects.ts";
...
export function useFilteredProjects({ selectedProjectId, query, includeProjectId, excludeChatProjects = false }: Options) {
