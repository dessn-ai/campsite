...
export function CommentRenderer(props: CommentRendererProps) {
    ...
    return (<div className='prose select-text focus:outline-none' data-reactions-only={hasReactionsOnly}>
      <AttachmentLightbox selectedAttachmentId={openAttachmentId} attachments={comment.attachments} viewOnly onClose={() => setOpenAttachmentId(undefined)} onSelectAttachment={({ id }) => setOpenAttachmentId(id)}/>
