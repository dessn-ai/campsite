...
import { AlertIcon, Button, UIText } from "../../../../packages/ui/src/index.tsx";
import * as Dialog from "../../../../packages/ui/src/Dialog/index.tsx";
import { useDeleteComment } from "../../hooks/useDeleteComment.ts";
import { clearNewCommentCoordinatesAtom, selectedCanvasCommentIdAtom } from "../CanvasComments/CanvasComments.tsx";
...
export function CommentDeleteDialog({ comment, subjectId, open, onOpenChange }: CommentDeleteDialogProps) {
    ...
    const description = comment.replies.length > 0
    ...
    return (<Dialog.Root open={open} onOpenChange={onOpenChange}>
      ...
      {comment.replies.length > 0 && (<Dialog.Content>
      ...
      <Dialog.Footer>
        <Dialog.TrailingActions>
          ...
          <Button variant='destructive' onClick={() => deleteCommentMutation.mutate(undefined, {
            onSuccess: () => handleCleanup()
        })} disabled={deleteCommentMutation.isPending} autoFocus>
            Delete
          </Button>
        </Dialog.TrailingActions>
      </Dialog.Footer>
