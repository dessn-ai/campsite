import { Project, TimelineEvent } from "../../../../packages/types/index.ts";
import { ArchiveIcon, ChatBubbleIcon, CheckCircleFilledFlushIcon, cn, LinearIcon, Link, PencilIcon, PinTackFilledIcon, PinTackIcon, ProjectIcon, RotateIcon, SignIcon, UIText } from "../../../../packages/ui/src/index.tsx";
import { ProjectHovercard } from "../InlinePost/ProjectHovercard.tsx";
...
import { isTimelineEventCreatedLinearIssueFromPost, isTimelineEventPostReferencedInLinearExternalRecord, isTimelineEventPostResolved, isTimelineEventPostUnresolved, isTimelineEventSubjectPinned, isTimelineEventSubjectReferencedInComment, isTimelineEventSubjectReferencedInNote, isTimelineEventSubjectReferencedInPost, isTimelineEventSubjectTitleUpdated, isTimelineEventSubjectUnpinned, isTimelineEventSubjectUpdatedProject, TimelineEventCreatedLinearIssueFromPost, TimelineEventPostReferencedInLinearExternalRecord, TimelineEventPostResolved, TimelineEventPostUnresolved, TimelineEventSubjectPinned, TimelineEventSubjectReferencedInComment, TimelineEventSubjectReferencedInNote, TimelineEventSubjectReferencedInPost, TimelineEventSubjectTitleUpdated, TimelineEventSubjectType, TimelineEventSubjectUnpinned, TimelineEventSubjectUpdatedProject } from "../../utils/timelineEvents/types.ts";
// ----------------------------------------------------------------------------
...
// ----------------------------------------------------------------------------
function TimelineEventSubjectTitleUpdatedComponent({ timelineEvent }: {
...
// ----------------------------------------------------------------------------
function TimelineEventPostResolvedComponent({ timelineEvent }: {
    timelineEvent: TimelineEventPostResolved;
}) {
    return (<TimelineEventContainer>
...
// ----------------------------------------------------------------------------
function TimelineEventPostUnresolvedComponent({ timelineEvent }: {
    timelineEvent: TimelineEventPostUnresolved;
}) {
    return (<TimelineEventContainer>
      <TimelineEventAccessory>
        <RotateIcon />
...
// ----------------------------------------------------------------------------
function TimelineEventPostReferencedInLinearExternalRecordComponent({ timelineEvent }: {
...
// ----------------------------------------------------------------------------
function TimelineEventCreatedLinearIssueFromPostComponent({ timelineEvent }: {
...
// ----------------------------------------------------------------------------
function TimelineEventSubjectPinnedComponent({ subjectType, timelineEvent }: {
    subjectType: TimelineEventSubjectType;
...
// ----------------------------------------------------------------------------
function TimelineEventSubjectUnpinnedComponent({ subjectType, timelineEvent }: {
    subjectType: TimelineEventSubjectType;
...
// ----------------------------------------------------------------------------
function TimelineEventSubjectReferencedInPostComponent({ subjectType, timelineEvent }: {
    subjectType: TimelineEventSubjectType;
...
// ----------------------------------------------------------------------------
function TimelineEventSubjectReferencedInCommentComponent({ subjectType, timelineEvent }: {
    subjectType: TimelineEventSubjectType;
    ...
    return (<TimelineEventContainer>
      ...
      <TimelineEventParagraphContainer>
        ...
        <Link href={comment_reference.url} className='group/link'>
          <UIText size='text-inherit' element='span' primary weight='font-medium' className='group-hover/link:underline'>
            comment
          </UIText>
...
// ----------------------------------------------------------------------------
function TimelineEventSubjectReferencedInNoteComponent({ subjectType, timelineEvent }: {
    subjectType: TimelineEventSubjectType;
 ...
 */
function InlineProjectAccessory({ project }: {
...
function TimelineEventSubjectUpdatedProjectComponent({ subjectType, timelineEvent }: {
    subjectType: TimelineEventSubjectType;
        ...
        {!!subject_updated_from_project && !!subject_updated_to_project ? (<>
            ...
            <ProjectHovercard projectId={subject_updated_from_project.id}>
              <Link href={`/${scope}/projects/${subject_updated_from_project.id}`} className='group/link inline'>
                ...
                <UIText primary element='span' size='text-inherit' weight='font-medium' className='group-hover/link:underline'>
...
// ----------------------------------------------------------------------------
export function TimelineEventSubject({ timelineEvent, subjectType }: {
