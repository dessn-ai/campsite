...
export function ProjectPermissionsSelect({ selected, onChange, disabled = false }: Props) {
    return (<Select disabled={disabled} value={selected} onChange={(value) => onChange(value as PermissionAction)} options={PERMISSION_ACTIONS} showCheckmark align='end' popoverWidth={180}/>);
}
