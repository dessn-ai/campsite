...
import { OauthApplication, Project } from "../../../../../packages/types/index.ts";
...
import { useCreateProjectOauthApp } from "../../../hooks/useCreateProjectOauthApp.ts";
import { useDeleteProjectOauthApp } from "../../../hooks/useDeleteProjectOauthApp.ts";
import { useGetOauthApplications } from "../../../hooks/useGetOauthApplications.ts";
import { useGetProjectOauthApps } from "../../../hooks/useGetProjectOauthApps.ts";
          ...
          {isFetching ? (<LazyLoadingSpinner />) : apps.length > 0 ? (<div className='flex-1 space-y-4 py-1'>
              {apps.map((oauthApp) => (<div className='flex items-center gap-3' key={oauthApp.id}>
                  ...
                  <div className='flex gap-1'>
                    {projectOauthApps?.find((app) => app.id === oauthApp.id) ? (<Button variant='destructive' type='button' onClick={() => onRemoveOauthApp(oauthApp)}>
                        Remove from channel
