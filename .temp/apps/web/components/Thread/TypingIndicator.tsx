...
import { chatThreadPlacementAtom } from "../Chat/atoms.tsx";
import { useChatTypingIndicator } from "../../hooks/useChatTypingIndicators.ts";
...
export const TypingIndicator = memo(function TypingIndicator({ threadId, channelName }: TypingIndicatorProps) {
    ...
    return (<div className={cn('pl-3.5asdfas pointer-events-none mt-1 lg:h-3.5', {
...
export const MobileTypingIndicator = memo(function TypingIndicator({ threadId, channelName }: TypingIndicatorProps) {
    ...
    if (typers.length === 0)
        return null;
    return (<div className={cn('bg-tertiary pointer-events-none items-center px-3 py-2.5', {
