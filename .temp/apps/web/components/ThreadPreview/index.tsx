...
export function ThreadPreview({ className, postId, username }: Props) {
    ...
    return (<div className='relative w-full transition-all active:scale-[0.99]'>
      <iframe ref={ref} className={cn('w-full overflow-hidden rounded-xl', className)} allowFullScreen src={`https://www.threads.net/@${username}/post/${postId}/embed`} data-text-app-payload-id={`ig-tp-${postId}`} sandbox='allow-scripts allow-same-origin allow-popups' height={height} scrolling='no'/>
