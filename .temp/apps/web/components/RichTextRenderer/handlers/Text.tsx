...
import { convertAttributes } from "../utils/attributes.ts";
...
export const Text: NodeHandler = ({ node }) => {
    ...
    ...finalAttrs } = convertAttributes(markAttrs);
    return (<Element {...finalAttrs} href={markAttrs.href} className={cn(finalAttrs.class, className)}>
