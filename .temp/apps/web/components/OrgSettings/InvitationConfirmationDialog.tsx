import { useInviteOrganizationMembers } from "../../hooks/useInviteOrganizationMembers.ts";
import { Button, Caption, UIText } from "../../../../packages/ui/src/index.tsx";
import * as Dialog from "../../../../packages/ui/src/Dialog/index.tsx";
import { FormInvitation } from "./InvitationForm.tsx";
      ...
      <Dialog.Root open={open} onOpenChange={onCancel} size='lg' align='top'>
        ...
        <Dialog.Content>
          <div className='bg-tertiary flex flex-col divide-y rounded-lg px-4 py-1'>
            ...
            .map((invitation) => (<div key={invitation.email} className='flex flex-col gap-2 py-3'>
                  ...
                  {invitation.projects.length > 0 && (<ul className='flex flex-col gap-1'>
                      {invitation.projects.map((project) => (<li key={`${invitation.email}:${project.id}`} className='flex items-center gap-1.5'>
        ...
        <Dialog.Footer>
          <Dialog.TrailingActions>
            ...
            <Button variant='primary' disabled={inviteTeamMembers.isPending} loading={inviteTeamMembers.isPending} onClick={handleSendInvitations} autoFocus>
              Send
            </Button>
          </Dialog.TrailingActions>
        </Dialog.Footer>
