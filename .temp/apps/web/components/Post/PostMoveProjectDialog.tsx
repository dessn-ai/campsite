...
export function PostMoveProjectDialog({ post, open, onOpenChange }: PostMoveProjectDialogProps) {
    ...
    const isDangerousPrivateChange = post.project?.private && !projects.find((project) => project.id === selectedProjectId)?.private;
      ...
      <Dialog.Root open={open} onOpenChange={handleOpenChange} size='lg' align='top' disableDescribedBy>
        ...
        <Dialog.Footer>
          <div className='flex flex-1 flex-col gap-3'>
            ...
            {post.project_pin_id && (<div className='flex items-start gap-2 rounded-md bg-orange-100 p-2 text-orange-800 dark:bg-orange-500/10 dark:text-orange-200'>
                <span>
                  <AlertIcon />
                </span>
                <UIText inherit>
            ...
            <div className='flex w-full items-center justify-between'>
              ...
              <div className='flex items-center gap-2'>
                ...
                <Button variant={isDangerousPrivateChange ? 'destructive' : 'primary'} type='submit' onClick={onSave} disabled={updatePostMutation.isPending}>
