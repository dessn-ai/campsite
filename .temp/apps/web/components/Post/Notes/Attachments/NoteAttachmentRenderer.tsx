...
import { EmbedContainer } from "../EmbedContainer.tsx";
/**
...
export function NoteAttachmentRenderer(props: NodeViewWrapperProps) {
    ...
    return (<EmbedContainer draggable selected={props.selected} editor={props.editor}>
      <InlineAttachmentRenderer id={id} optimisticId={optimistic_id} error={error} editable={editable} onOpen={props.extension.options.onOpenAttachment} onDelete={editable ? props.deleteNode : undefined} commentsEnabled={!props.extension.options.disableComments} width={props.node.attrs.width} height={props.node.attrs.height}/>
    </EmbedContainer>);
}
