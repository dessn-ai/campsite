...
import { fitDimensions } from "./ImageAttachment.tsx";
interface Props {
...
export function VideoAttachment(props: Props) {
    ...
    return (<video id={`attachment-${attachment.id}`} preload='metadata' draggable={false} width={width} height={height} className={cn('h-full max-h-[80vh] w-full max-w-full rounded object-contain transition-shadow', {
