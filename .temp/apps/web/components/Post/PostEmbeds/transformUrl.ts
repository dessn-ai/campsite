...
import { codepenRegex, codesandboxRegex, figmaRegex, loomRegex, playRegex, riveRegex, tomeRegex, youtubeRegex } from "../../../../../packages/regex/src/index.ts";
...
type EmbedType = 'link' | 'loom' | 'figma' | 'codepen' | 'codesandbox' | 'rive' | 'storybook' | 'play' | 'tome' | 'youtube';
