...
export function PostViewersFacepilePopover({ post }: {
    ...
    if (!post.viewer_is_organization_member)
        return null;
    if (totalViewCount === 0 && totalFollowUps === 0)
        return null;
    if (!facepileUsers.length)
        return null;
    return (<PostViewersPopover post={post}>
