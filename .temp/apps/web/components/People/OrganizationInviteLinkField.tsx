...
import { useGetInvitationUrl } from "../../hooks/useGetInvitationUrl.ts";
import { useResetOrganizationInviteToken } from "../../hooks/useResetOrganizationInviteLink.ts";
export function OrganizationInviteLinkField({ onboarding }: {
    onboarding?: boolean;
}) {
    ...
    return (<div className='flex items-center gap-2'>
      <div className='flex w-full flex-col'>
        <TextField id='invitation-link' name='invitation-link' readOnly label='Invitation link' labelHidden clickToCopy value={data.invitation_url}/>
      </div>
