...
import { UIText, UserCircleIcon } from "../../../../packages/ui/src/index.tsx";
import { IndexPageEmptyState } from "../IndexPages/components.tsx";
import { InvitePeopleButton } from "./InvitePeopleButton.tsx";
import { PeopleIndexFilterType, roleFilterAtom, RoleType, rootFilterAtom, searchAtom } from "./PeopleIndex.tsx";
...
export function PeopleIndexEmptyState({ description: customDescription }: {
    description?: string;
}) {
    ...
    return (<IndexPageEmptyState>
      ...
      <div className='flex flex-col gap-1'>
        ...
        {uiDescription && (<UIText size='text-base' tertiary>
            {uiDescription}
          </UIText>)}
      </div>
