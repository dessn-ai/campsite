...
import { useReadOnlyOnCheckboxClick } from "../../hooks/useReadOnlyOnCheckboxClick.ts";
interface Props {
    text?: string;
    linkOptions?: {
        truncate?: boolean;
...
export function HTMLRenderer({ text, onCheckboxClick, linkOptions, blur = false, className = 'prose w-full max-w-full select-text focus:outline-none', as = 'div', ...props }: Props) {
    ...
    return (<Element {...props} id={containerId} className={cn(className, {
