...
import { PrivateNoteIcon, Select, SelectTrigger, SelectValue } from "../../../../packages/ui/src/index.tsx";
...
export function NoteProjectPicker({ note, disabled }: ProjectPickerProps) {
    ...
    return (<Select typeAhead showCheckmark align='center' value={value} disabled={disabled} onQueryChange={setQuery} options={options} onChange={(value) => {
            if (value === 'none') {
