import { DragEvent, forwardRef, KeyboardEvent, memo, MouseEvent, useEffect, useImperativeHandle, useRef, useState } from 'react';
import { HocuspocusProvider } from '@hocuspocus/provider';
import { Editor as TTEditor } from '@tiptap/core';
import { EditorContent } from '@tiptap/react';
import { useSetAtom } from 'jotai';
import { ActiveEditorComment, BlurAtTopOptions, focusAtStartWithNewline } from "../../../../packages/editor/src/index.ts";
...
import { ResourceMentionList } from "../MarkdownEditor/ResourceMentionList.tsx";
import { ADD_ATTACHMENT_SHORTCUT, SlashCommand } from "../Post/Notes/SlashCommand.tsx";
...
import { DropProps, useEditorFileHandlers } from "../MarkdownEditor/useEditorFileHandlers.ts";
import { HighlightCommentPopover } from "../NoteComments/HighlightCommentPopover.tsx";
import { useUploadNoteAttachments } from "../Post/Notes/Attachments/useUploadAttachments.ts";
import { NoteCommentPreview } from "../Post/Notes/CommentRenderer.tsx";
import { useNoteEditor } from "../Post/Notes/useNoteEditor.tsx";
interface Props {
...
export const NoteContent = memo(forwardRef<NoteContentRef, Props>((props, ref) => {
    ...
    return (<div ref={containerRef} className={cn('relative', { 'opacity-50': isSyncError })}>
        ...
        <NoteCommentPreview onExpand={() => {
            if (hoverComment) {
                setHoverComment(null);
                setActiveComment(hoverComment);
            }
        }} previewComment={activeComment ? null : hoverComment} editor={editor} noteId={noteId}/>
        ...
        <HighlightCommentPopover activeComment={activeComment} editor={editor} noteId={noteId} onCommentDeactivated={() => setActiveComment(null)}/>
