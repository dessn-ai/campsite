...
import { FigmaFileAttachmentDetails } from "../../../../packages/types/generated.ts";
import { useScope } from "../../contexts/scope.tsx";
import { useCreateAttachment } from "../../hooks/useCreateAttachment.ts";
import { useCreateFigmaFileAttachment } from "../../hooks/useCreateFigmaFileAttachment.ts";
import { useGetFigmaIntegration } from "../../hooks/useGetFigmaIntegration.ts";
import { createOptimisticAttachment } from "../../utils/createFileUploadPipeline.ts";
import { setOptimisticAttachment, updateOptimisticAttachment } from "../Post/Notes/Attachments/useUploadAttachments.ts";
...
export function useCreateLinkAttachment() {
     ...
     */
    const createLink = useCallback(async ({ url, editor, chain }: {
        url: string;
        editor: Editor;
