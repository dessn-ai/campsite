...
import { Button, InboxIcon, Link, LoadingSpinner, UIText } from "../../../../packages/ui/src/index.tsx";
import { HoverCard } from "../../../../packages/ui/src/HoverCard/index.ts";
import { CreateChatThreadDialog } from "./CreateChatThreadDialog.tsx";
...
import { ExistingThreadListItem } from "./ExistingThreadListItem.tsx";
export function ChatHoverList({ children, side = 'right', align = 'start', sideOffset = 0, alignOffset = 0, disabled: _disabled = false }: {
    ...
    return (<>
      <HoverCard open={open} onOpenChange={setOpen} disabled={disabled} targetHref={href}>
        ...
        <HoverCard.Content side={side} align={align} sideOffset={sideOffset} alignOffset={alignOffset}>
          ...
          {!hasChatThreads && !isLoading && (<div className='flex flex-1 items-center justify-center px-6 py-12'>
...
function ThreadsList({ threads }: {
    ...
    return (<div className='scrollbar-hide flex max-h-[400px] flex-col overflow-y-auto overscroll-contain p-2'>
