...
import { usePostComposerLastUsedProjectId } from "./hooks/usePostComposerLastUsedProjectId.ts";
...
function InnerPostComposerSyncLastUsedProject() {
    ...
    useEffect(() => {
        ...
        const lastUsedProjectNotFound = lastUsedProjectId && projects && projects.length && !projects.some((p) => p.id === lastUsedProjectId);
        // skip if disabled
