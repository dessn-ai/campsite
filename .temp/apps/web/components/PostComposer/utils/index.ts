...
import { atomWithToggle } from "../../../utils/atomWithToggle.ts";
// ----------------------------------------------------------------------------
...
function isDraftType(type?: PostComposerType): boolean {
    return (type === PostComposerType.Draft ||
...
type PostComposerState = {
    ...
    type: PostComposerType.Draft | PostComposerType.DraftFromPost | PostComposerType.DraftFromNote | PostComposerType.DraftFromCall | PostComposerType.DraftFromMessage | PostComposerType.DraftFromComment | PostComposerType.DraftFromText;
} | {
...
const isPostComposerExpandedAtomFamily = atomFamily((presentation: PostComposerPresentation) => atomWithToggle(getIsPostComposerExpandedDefaultValue(presentation)));
// ----------------------------------------------------------------------------
...
// ----------------------------------------------------------------------------
export { PostComposerSuccessBehavior, PostComposerPresentation, PostComposerType, PostComposerAction, postComposerStateAtom, isPostComposerExpandedAtomFamily, getIsPostComposerExpandedDefaultValue, isDraftType, getSubmitButtonId, getSaveDraftButtonId };
