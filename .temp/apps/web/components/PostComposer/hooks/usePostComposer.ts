...
import { Attachment, Call, Comment, Message, Note, Post } from "../../../../../packages/types/generated.ts";
import { shortTimestamp } from "../../../../../packages/ui/src/RelativeTime/index.tsx";
import { getPostSchemaDefaultValues, postDefaultValues } from "../../Post/schema.ts";
import { useDefaultComposerValues } from "./useDefaultComposerValues.ts";
import { usePostComposerLocalDraftValue } from "./usePostComposerLocalDraft.ts";
import { usePostComposerPresentation } from "./usePostComposerPresentation.ts";
import { PostComposerPresentation, postComposerStateAtom, PostComposerSuccessBehavior, PostComposerType } from "../utils/index.ts";
import { useCreateAttachment } from "../../../hooks/useCreateAttachment.ts";
import { createMentionHtml } from "../../../utils/createMentionHtml.ts";
...
export function usePostComposer() {
    ...
    const showPostComposer = useCallback(async ({ successBehavior = PostComposerSuccessBehavior.Toast, projectId: project_id = defaultProjectId, ...props }: ShowPostComposerArgs = {}) => {
        ...
        switch (props.type) {
            ...
            case PostComposerType.DraftFromMessage: {
                ...
                try {
                    ...
                    await Promise.all(message.attachments.map(async (message_attachment, index) => {
