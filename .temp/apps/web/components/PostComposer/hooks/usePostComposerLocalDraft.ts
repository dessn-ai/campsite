...
// ----------------------------------------------------------------------------
const postComposerLocalDraftAtomFamily = atomFamily((scope: string) => atomWithWebStorage<PostSchema | undefined>(`${scope}:localDraftPost-dialog`, undefined));
...
function usePostComposerLocalDraftActions() {
    ...
    const updateLocalDraft = useCallback((post: PostSchema) => {
