...
export function PostComposerUnfurledLink() {
    ...
    return (<div className='group/remove-container relative mx-3 max-w-lg'>
      <RichLinkCard url={unfurledLink} interactive={false} onForceRemove={removeLink}/>

      <PostComposerRemoveButton disabled={methods.formState.isSubmitting} accessibilityLabel='Remove link preview' onClick={removeLink}/>
    </div>);
}
