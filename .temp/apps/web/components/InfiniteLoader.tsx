...
import { Button, LazyLoadingSpinner, UIText } from "../../../packages/ui/src/index.tsx";
interface Props {
    hasNextPage: boolean;
    isError: boolean;
    isFetching: boolean;
...
export function InfiniteLoader(props: Props) {
    ...
    if (!hasNextPage)
        return null;
    return (<div className='relative flex w-full items-center justify-center p-14'>
      <div className='absolute -top-11' ref={ref}></div>
      {isError && !isFetching && (<div className='flex flex-col gap-3 align-middle'>
