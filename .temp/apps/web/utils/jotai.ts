 ...
 */
export function HydrateAtoms<T extends (readonly [
    AnyWritableAtom,
    unknown
])[]>({ atomValues, children }: {
...
export function HydrateAtoms<T extends Map<AnyWritableAtom, unknown>>({ atomValues, children }: {
    atomValues: T;
    children: React.ReactNode;
}): React.ReactNode;
export function HydrateAtoms<T extends Iterable<readonly [
    AnyWritableAtom,
    unknown
]>>({ atomValues, children }: {
    atomValues: INTERNAL_InferAtomTuples<T>;
