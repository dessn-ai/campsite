...
export function createRetryAtoms<T>() {
    ...
    const setStateAtom = atom(null, (_get, set, { optimisticId, state }: {
        optimisticId: string;
    ...
    const updateStateAtom = atom(null, (_get, set, { optimisticId, status }: {
        optimisticId: string;
    ...
    const removeStateAtom = atom(null, (_get, set, { optimisticId }: {
        optimisticId: string;
    }) => {
        set(createAtom, (prev) => {
