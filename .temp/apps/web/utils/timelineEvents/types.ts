import { Comment, ExternalRecord, MiniProject, Note, OrganizationMember, Post, TimelineEvent } from "../../../../packages/types/generated.ts";
// ----------------------------------------------------------------------------
...
export function isTimelineEventSubjectTitleUpdated(event: TimelineEvent): event is TimelineEventSubjectTitleUpdated {
    return (event.action === 'subject_title_updated' &&
        !!event.member_actor &&
...
export function isTimelineEventPostReferencedInLinearExternalRecord(event: TimelineEvent): event is TimelineEventPostReferencedInLinearExternalRecord {
    return (event.action === 'post_referenced_in_external_record' &&
...
export function isTimelineEventCreatedLinearIssueFromPost(event: TimelineEvent): event is TimelineEventCreatedLinearIssueFromPost {
    return (event.action === 'created_linear_issue_from_post' &&
        !!event.external_reference &&
...
export function isTimelineEventCommentReferencedInLinearExternalRecord(event: TimelineEvent): event is TimelineEventCommentReferencedInLinearExternalRecord {
    return (event.action === 'comment_referenced_in_external_record' &&
        !!event.external_reference &&
        (isLinearIssueExternalRecord(event.external_reference) || isLinearCommentExternalRecord(event.external_reference)));
}
// ----------------------------------------------------------------------------
...
export function isTimelineEventCreatedLinearIssueFromComment(event: TimelineEvent): event is TimelineEventCreatedLinearIssueFromComment {
    return (event.action === 'created_linear_issue_from_comment' &&
        !!event.external_reference &&
        isLinearIssueExternalRecord(event.external_reference));
}
// ----------------------------------------------------------------------------
...
export function isTimelineEventSubjectReferencedInInternalRecord(event: TimelineEvent): event is TimelineEventSubjectReferencedInInternalRecord {
...
export function isTimelineEventSubjectReferencedInPost(event: TimelineEvent): event is TimelineEventSubjectReferencedInPost {
...
export function isTimelineEventSubjectReferencedInComment(event: TimelineEvent): event is TimelineEventSubjectReferencedInComment {
    return (event.action === 'subject_referenced_in_internal_record' &&
        !!event.member_actor &&
...
export function isTimelineEventSubjectReferencedInNote(event: TimelineEvent): event is TimelineEventSubjectReferencedInNote {
...
export function isTimelineEventSubjectUpdatedProject(event: TimelineEvent): event is TimelineEventSubjectUpdatedProject {
    return (event.action === 'subject_project_updated' &&
        !!event.member_actor &&
