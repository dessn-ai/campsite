...
import { Favorite, MessageThread, Project } from "../../../packages/types/index.ts";
import { apiClient, getTypedQueryData, setTypedQueriesData } from "./queryClient.ts";
...
export function insertOptimisticFavorite({ queryClient, scope, favoritableId, favoritableType, name, project = null, messageThread = null, url }: InsertOptimisticFavoriteOpts) {
    const newFavorite = {
