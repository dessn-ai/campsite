...
import { NormalizerConfig } from "./core/index.ts";
import { createQueryNormalizer } from "./react-query/create-query-normalizer.ts";
const QueryNormalizerContext = React.createContext<undefined | ReturnType<typeof createQueryNormalizer>>(undefined);
export const QueryNormalizerProvider = ({ queryClient, normalizerConfig, children }: {
